...
public:
	ImageNavigatingWidget(VISIOCYTEPluginCallback &callback, QString m_FileName, QString curFilePathInput, float scaleFactorInput)
	{
		...
		// init visiocyte windows
		update_visiocyteviews(callback, roi_start_x*scaleFactor, roi_start_y*scaleFactor, roi_start_z*scaleFactor, roi_end_x*scaleFactor, roi_end_y*scaleFactor, roi_end_z*scaleFactor);
...
public slots:
	...
	void update_visiocyteviews(VISIOCYTEPluginCallback &callback, long start_x, long start_y, long start_z, long end_x, long end_y, long end_z)
	{
		// visualize in visiocyte tri-view
...
// interface visiocyte plugin
class MIViewerPlugin : public QObject, public VISIOCYTEPluginInterface
{
    Q_OBJECT
