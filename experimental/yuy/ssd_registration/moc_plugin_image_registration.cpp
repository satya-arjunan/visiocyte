...
void *ImageRegistrationPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "VISIOCYTEPluginInterface"))
        return static_cast< VISIOCYTEPluginInterface*>(const_cast< ImageRegistrationPlugin*>(this));
    if (!strcmp(_clname, "com.janelia.visiocyte.VISIOCYTEPluginInterface/1.1"))
        return static_cast< VISIOCYTEPluginInterface*>(const_cast< ImageRegistrationPlugin*>(this));
