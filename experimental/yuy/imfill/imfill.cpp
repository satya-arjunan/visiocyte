...
void imfilling(VISIOCYTEPluginCallback &callback, QWidget *parent);
...
void ImFillPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback &callback, QWidget *parent)
{
...
void imfilling(VISIOCYTEPluginCallback &callback, QWidget *parent)
{
	...
	// de-alloc
	//if (pSbject) {delete []pSbject; pSbject=0;} // image visualized in visiocyte now
