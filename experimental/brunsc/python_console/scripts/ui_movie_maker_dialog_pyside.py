...
class Ui_movie_dialog(object):
    ...
    def retranslateUi(self, movie_dialog):
        movie_dialog.setWindowTitle(QtGui.QApplication.translate("movie_dialog", "VisiocyteCinema Movie Maker", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtGui.QApplication.translate("movie_dialog", "Key Frames", None, QtGui.QApplication.UnicodeUTF8))
        self.addCurrentViewButton.setToolTip(QtGui.QApplication.translate("movie_dialog", "Add new key frame from current Visiocyte 3D viewer state to your movie", None, QtGui.QApplication.UnicodeUTF8))
