function save_visiocyte_marker_file(m_struct, filename)
%function save_visiocyte_marker_file(m_struct, filename)
%
% Save the .marker format data file used in VISIOCYTE
% 
...
fp = fopen(filename, 'w');
if (fp<0),
    disp('Fail to open the file to save VISIOCYTE .marker format data');
    return;
end;
