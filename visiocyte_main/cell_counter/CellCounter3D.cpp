...
void CellCounter3D::loadInputFile() {
    ...
    if (tmpImage.getDatatype()!=VISIOCYTE_UINT8) {
...
bool CellCounter3D::findCells() {
    ...
    for (planStepPosition=0;planStepPosition<findPasses;planStepPosition++) {
        ...
        for (int i=0;i<regionGroups.size();i++) {
            ...
            VISIOCYTELONG groupSize=group.size();
            VISIOCYTELONG zTotal=0L;
            VISIOCYTELONG yTotal=0L;
            VISIOCYTELONG xTotal=0L;
            ...
            VISIOCYTELONG zAvg=(zTotal*3)/groupSize;
            VISIOCYTELONG yAvg=(yTotal*3)/groupSize;
            VISIOCYTELONG xAvg=(xTotal*3)/groupSize;
            qDebug() << "Region " << i << " zAvg=" << zAvg << " yAvg=" << yAvg << " xAvg=" << xAvg;
            VISIOCYTELONG zeroCount=0L;
            VISIOCYTELONG flipCount=0L;
        ...
        VISIOCYTELONG preBinaryViolationCount=regionViolationCount(workingData[w1][0]);
        ...
        VISIOCYTELONG postBinaryViolationCount=regionViolationCount(workingData[w2][0]);
...
//        }
        ...
        VISIOCYTELONG postErosionViolationCount=regionViolationCount(workingData[w1][0]);
        ...
        VISIOCYTELONG postDialationViolationCount=regionViolationCount(workingData[w1][0]);
...
//        }
        ...
        VISIOCYTELONG postCenterSurroundViolationCount=regionViolationCount(workingData[w1][0]);
...
VISIOCYTELONG CellCounter3D::regionViolationCount(unsigned char*** w) {
    VISIOCYTELONG vCount=0L;
    for (int i=0;i<regionGroups.size();i++) {
        QList<int> group=regionGroups[i];
        VISIOCYTELONG groupSize=group.size();
        VISIOCYTELONG zTotal=0L;
        ...
        VISIOCYTELONG zAvg=zTotal/groupSize;
        VISIOCYTELONG yAvg=yTotal/groupSize;
        VISIOCYTELONG xAvg=xTotal/groupSize;
        //qDebug() << "Region " << i << " zAvg=" << zAvg << " yAvg=" << yAvg << " xAvg=" << xAvg;
        VISIOCYTELONG zeroCount=0L;
        VISIOCYTELONG flipCount=0L;
        for (int ez=zAvg-MARK_RADIUS;ez<zAvg+MARK_RADIUS;ez++) {
