...
#define  __visiocyte_custom_toolbar_plugin__
#endif
...
#endif
typedef void (Visiocyte_PluginLoader::*VisiocytePluginLoaderFunc)();
#endif
typedef void (TriviewControl::*TriviewFunc)();
typedef void (View3DControl::*View3DFunc)();
typedef void (VISIOCYTEPluginCallback2::*Callback2Func)(visiocytehandle);
typedef void (VISIOCYTEPluginInterface2_1::*PluginMenuFunc)(const QString &menu_name, VISIOCYTEPluginCallback2 &callback, QWidget *parent);
...
class CustomToolButton : public QObject
{
	...
	public:
		...
		QWidget * parent;   // parent should be visiocyte MainWindow type, when invoke QMainWindow menu action
		...
		QString buttonName; // the identification of different button. With Format:
							...
							// plugin menu     : plugin path + menu name, eg. /home/hang/Applications/visiocyte/plugin/ct3d/libct3d_debug.dylib::About
...
class CustomToolbarSelectWidget : public QWidget
{
	...
	public:
		CustomToolbarSelectWidget(CustomToolbarSetting * _cts, VISIOCYTEPluginCallback2 *callback, QWidget * parent);
...
{
public:
	CustomToolbar(QString title , VISIOCYTEPluginCallback2 * callback, QWidget * parent);
	CustomToolbar(CustomToolbarSetting * _cts , VISIOCYTEPluginCallback2 * callback, QWidget * parent);
	~CustomToolbar();
