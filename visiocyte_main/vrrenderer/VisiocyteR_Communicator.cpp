#include "VisiocyteR_Communicator.h"
...
VisiocyteR_Communicator::VisiocyteR_Communicator(bool *client_flag, QList<NeuronTree>* ntlist) :
	QWidget()
{
...
VisiocyteR_Communicator::~VisiocyteR_Communicator() {

}

bool VisiocyteR_Communicator::SendLoginRequest() {
...
void VisiocyteR_Communicator::onReadySend(QString &send_MSG) {
...
void VisiocyteR_Communicator::onReadyRead() {
...
void VisiocyteR_Communicator::onConnected() {

    socket->write(QString("/login:" +userName + "\n").toUtf8());

}

void VisiocyteR_Communicator::onDisconnected() {
...
void VisiocyteR_Communicator::Update3DViewNTList(QString &msg, int type)//may need to be changed to AddtoNTList( , )
{	
...
//void VisiocyteR_Communicator::SendHMDPosition()
//{
...
//}
//void VisiocyteR_Communicator::RunVRMainloop()
//{
//
