...
mkdir /Volumes/NeuronAnnotator-${visiocyte_version}/.background
# background file must not be hidden when setting background
chflags nohidden /Volumes/NeuronAnnotator-${visiocyte_version}/background.png

# Use applescript language to arrange view
echo "
   tell application \"Finder\"
     tell disk \"NeuronAnnotator-${visiocyte_version}\"
           open
...
chflags hidden /Volumes/NeuronAnnotator-${visiocyte_version}/background.png
sleep 2

cp "/Volumes/NeuronAnnotator-${visiocyte_version}/.DS_Store" "./DS_Store_na_${visiocyte_version}"
hdiutil detach "/Volumes/NeuronAnnotator-${visiocyte_version}"
