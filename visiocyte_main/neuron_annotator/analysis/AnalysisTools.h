...
public:
    ...
    AnalysisTools();
    static My4DImage* cubifyImageByChannel(My4DImage * sourceImage, int sourceChannel, int cubeSize, int type, VISIOCYTELONG* subregion,
    ...
    static My4DImage* createMIPFromImageByLUT(My4DImage * image, visiocyte_uint8 * lut);
    static visiocyte_uint8  getReverse16ColorLUT(visiocyte_uint8 * lut, visiocyte_uint8 r, visiocyte_uint8 g, visiocyte_uint8 b);
    static visiocyte_uint8* create16Color8BitLUT_fiji();
    static visiocyte_uint8* create16Color8BitLUT();
