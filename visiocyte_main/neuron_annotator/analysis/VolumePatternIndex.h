...
private:
    ...
    VISIOCYTELONG qx0, qx1, qy0, qy1, qz0, qz1;
    VISIOCYTELONG iXmax, iYmax, iZmax;
    ...
    QList<VISIOCYTELONG> indexScoreList;
    ...
    VISIOCYTELONG calculateIndexScore(unsigned char* queryIndex, unsigned char* subjectIndex, VISIOCYTELONG indexTotal, unsigned char* skipPositions);
    VISIOCYTELONG computeTotalBytesFromIndexTotal(VISIOCYTELONG indexTotal);

    static bool compareScores(QPair<VISIOCYTELONG, int> p1, QPair<VISIOCYTELONG, int> p2) {
