...
public:
    ...
    My4DImage * create3DHeatmapFromChannel(My4DImage * sourceImage, VISIOCYTELONG sourceChannel, visiocyte_uint8 * lookupTable);
    visiocyte_uint8 * create16Color8BitLUT_V2();
    visiocyte_uint8 * create16Color8BitLUT_V3();
...
private:
    ...
    visiocyte_uint8 zoneThresholds[4];
