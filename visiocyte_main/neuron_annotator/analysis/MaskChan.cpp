...
QList<int> MaskChan::getFragmentListFromLabelStack()
{
  ...
  visiocyte_uint8* label8=0L;
  visiocyte_uint16* label16=0L;
  if (labelImage->getDatatype()==VISIOCYTE_UINT8) {
...
bool MaskChan::createMaskChanForLabel(int label, const QString& maskFullPath, const QString& channelFullPath, QReadWriteLock* mutex)
{
  ...
  if (sourceImage->getDatatype()==VISIOCYTE_UINT8) {
    data=(void*) new visiocyte_uint8[unitsNeeded];
  } else {
    data=(void*) new visiocyte_uint16[unitsNeeded];
  }
  ...
  if (sourceImage->getDatatype()==VISIOCYTE_UINT16) {
    datatype=2; // 16-bit
  }
			  ...
			  long& x0, long& x1, long& y0, long& y1, long& z0, long& z1, void* data, long assumedVoxelCount)
{
  ...
  visiocyte_uint8* source8=0L;
  visiocyte_uint16* source16=0L;
  visiocyte_uint8* data8=0L;
  visiocyte_uint16* data16=0L;
  if (sourceImage->getDatatype()==VISIOCYTE_UINT8) {
    source8=(visiocyte_uint8*)sourceImage->getRawData();
    data8=(visiocyte_uint8*)data;
  } else {
    source16=(visiocyte_uint16*)sourceImage->getRawData();
    data16=(visiocyte_uint16*)data;
  }
	  ...
	  data16=new visiocyte_uint16*[cdim];
        ...
        if (outputStack==0L) {
            ...
            if (chanBytesPerChannel==0 || chanBytesPerChannel==1) {
                outputStack->loadImage(xdim, ydim, zdim, cdim, VISIOCYTE_UINT8);
            } else if (chanBytesPerChannel==2) {
                outputStack->loadImage(xdim, ydim, zdim, cdim, VISIOCYTE_UINT16);
            } else {
        ...
        for (int c=0;c<cdim;c++) {
            if (chanBytesPerChannel==0 || chanBytesPerChannel==1) {
                ...
                data8[c]=0L;
                data16[c]=(visiocyte_uint16*)outputStack->getRawDataAtChannel(c);
            }
        }

        visiocyte_uint16* chanData16=(visiocyte_uint16*)chanData;
