...
public:
    ...
    bool inNeuronMask(VISIOCYTELONG x, VISIOCYTELONG y, VISIOCYTELONG z);
...
private:
    int index;
    VISIOCYTELONG xlc, ylc, zlc; // current mouse left click location in 3D

    const DataFlowModel* dataFlowModel;

    VISIOCYTELONG sx, sy, sz;
    VISIOCYTELONG curNeuronBDxb, curNeuronBDxe, curNeuronBDyb, curNeuronBDye, curNeuronBDzb, curNeuronBDze;
