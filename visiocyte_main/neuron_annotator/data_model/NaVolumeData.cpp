...
bool NaVolumeData::loadBestVolumeFromDirectory( QUrl dirName )
{
    ...
    QList<QString> extensions; // e.g. ConsolidatedSignal3.*visiocytepbd*
    extensions << "visiocytepbd" << "mp4" << "visiocyteraw" << "tiff";

    QList<QString> suffixes; // e.g. ConsolidatedSignal*3*.visiocytepbd

    QList<QString> bestSignalFiles;
    bestSignalFiles << "ConsolidatedSignal3.visiocytepbd"; // first choice, 16-bit, linear
    bestSignalFiles << "ConsolidatedSignal2.visiocytepbd"; // second choice, 8-bit, sRGB
    bestSignalFiles << "ConsolidatedSignal.visiocytepbd"; // third choice, y-flipped, 8-bit, linear
...
My4DImage* transformStackToLinear( My4DImage* img1, QUrl fileUrl )
{
    ...
    img2->loadImage( sx, sy, sz, sc, VISIOCYTE_UINT16 );
...
bool NaVolumeData::queueSeparationFolder( QUrl folder ) // using new staged loader
{
...
#if 0
    *candidate << new ProgressiveSingleFileCompanion( "ConsolidatedSignal3.visiocytepbd" );
    *candidate << new ProgressiveSingleFileCompanion( "ConsolidatedLabel3.visiocytepbd", CHANNEL_LABEL );
    *candidate << new ProgressiveSingleFileCompanion( "Reference3.visiocytepbd", CHANNEL_ALPHA );
    *volumeItem << candidate;
    // Next try 8-bit gamma corrected files
    candidate = new ProgressiveLoadCandidate();
    *candidate << new ProgressiveSingleFileCompanion( "ConsolidatedSignal2.visiocytepbd" );
    *candidate << new ProgressiveSingleFileCompanion( "ConsolidatedLabel2.visiocytepbd", CHANNEL_LABEL );
    *candidate << new ProgressiveSingleFileCompanion( "Reference2.visiocytepbd", CHANNEL_ALPHA );
    *volumeItem << candidate;
    // Finally try original y-flipped mixed bit-depth files
    candidate = new ProgressiveLoadCandidate();
    *candidate << &( ( new ProgressiveSingleFileCompanion( "ConsolidatedSignal.visiocytepbd" ) )->setFlippedY( true ) );
    *candidate << &( ( new ProgressiveSingleFileCompanion( "ConsolidatedLabel.visiocytepbd", CHANNEL_LABEL ) )->setFlippedY( true ) );
    *candidate << new ProgressiveSingleFileCompanion( "Reference.visiocytepbd", CHANNEL_ALPHA );
    *volumeItem << candidate;
    //
    candidate = new ProgressiveLoadCandidate();
    *candidate << new ProgressiveSingleFileCompanion( "ConsolidatedSignal.visiocyteraw" );
    *candidate << new ProgressiveSingleFileCompanion( "ConsolidatedLabel.visiocyteraw", CHANNEL_LABEL );
    *candidate << new ProgressiveSingleFileCompanion( "Reference.visiocyteraw", CHANNEL_ALPHA );
    *volumeItem << candidate;
    //
    ...
    *signal << new ProgressiveFileElement( "ConsolidatedSignal3.visiocytepbd", CHANNEL_RGB, false );
    *signal << new ProgressiveFileElement( "ConsolidatedSignal2.visiocytepbd", CHANNEL_RGB, false );
    *signal << new ProgressiveFileElement( "ConsolidatedSignal.visiocytepbd", CHANNEL_RGB, true );
    *signal << new ProgressiveFileElement( "ConsolidatedSignal.visiocyteraw", CHANNEL_RGB, false );
    if ( !visuallyLosslessImage.isEmpty() )
    {
       std::string str = visuallyLosslessImage.toString().toStdString();
       std::size_t found = str.find_last_of( "/\\" );
    ...
    *label << new ProgressiveFileElement( "ConsolidatedLabel3.visiocytepbd", CHANNEL_LABEL, false );
    *label << new ProgressiveFileElement( "ConsolidatedLabel2.visiocytepbd", CHANNEL_LABEL, false );
    *label << new ProgressiveFileElement( "ConsolidatedLabel.visiocytepbd", CHANNEL_LABEL, true );
    *label << new ProgressiveFileElement( "ConsolidatedLabel.visiocyteraw", CHANNEL_LABEL, false );
    ...
    *reference << new ProgressiveFileElement( "Reference3.visiocytepbd", CHANNEL_ALPHA, false );
    *reference << new ProgressiveFileElement( "Reference2.visiocytepbd", CHANNEL_ALPHA, false );
    *reference << new ProgressiveFileElement( "Reference.visiocytepbd", CHANNEL_ALPHA, false );
    *reference << new ProgressiveFileElement( "Reference.visiocyteraw", CHANNEL_ALPHA, false );
...
bool NaVolumeData::Writer::loadVolumeFromTexture( const VolumeTexture* texture )
{
        ...
        return false;
    {
        ...
        volImg->createImage( sx, sy, sz,
                             3, // RGB
                             VISIOCYTE_UINT8 ); // 1 => 8 bits per value
        My4DImage* refImg = new My4DImage();
