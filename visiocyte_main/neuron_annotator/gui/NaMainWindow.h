...
class NaMainWindow : public QMainWindow
{
  ...
  public:
    ...
    Na3DWidget* get3DWidget() {return ui->visiocyter_glwidget;}
    char* getConsoleURL();

  signals:
    void channelVisibilityChanged( int, bool );
    void nutatingChanged( bool );
    void defaultVisiocyteFileLoadRequested( QString fileName );
    void defaultVisiocyteUrlLoadRequested( QUrl url );
  ...
  public slots:
    ...
    void loadSingleStack( QUrl url, bool useVisiocyteClassic );
    ...
    void on_actionVISIOCYTEDefault_triggered();
