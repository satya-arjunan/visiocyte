...
protected:
    ...
    VISIOCYTELONG sx, sy, sz, sc; // dimensions of image
    VISIOCYTELONG cx, cy, cz, cc;
    // , cr;
    VISIOCYTELONG cur_x, cur_y, cur_z, cur_c, pre_c;
    VISIOCYTELONG hdrBoxSize;
