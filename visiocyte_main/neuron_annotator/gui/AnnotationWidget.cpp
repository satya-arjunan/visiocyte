#include "../../3drenderer/visiocyter_common.h" // Pick up Glee first
...
void AnnotationWidget::consoleConnect() {
    ...
    connect(consoleObserver, SIGNAL(openStackWithVisiocyte(Entity*)), naMainWindow, SLOT(loadSingleStack(Entity*)));
