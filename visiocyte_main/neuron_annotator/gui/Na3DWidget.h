...
#include "../../visiocyte/xformwidget.h"
#include "NaViewer.h"
...
// Derived class of VisiocyteR_GLWidget so we can use a simpler constructor
 ...
 *   zoom level
 */
class Na3DWidget : public VisiocyteR_GLWidget, public NaViewer
{
    Q_OBJECT
...
protected:
    ...
    // visiocyter_glwidget::event() can cause crash
