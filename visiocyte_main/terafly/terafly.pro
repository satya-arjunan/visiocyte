...
# enable Visiocyte-TeraFly mode
DEFINES += _VISIOCYTE_TERAFLY_PLUGIN_MODE
...
#set up Visiocyte and Qt source path
VISIOCYTEMAINPATH =  ..
QT_PATH = $$dirname(QMAKE_QMAKE)/..

#HDF5 headers and precompiled library and dependencies (libz and libszip)
INCLUDEPATH += $$VISIOCYTEMAINPATH/common_lib/include/hdf5

win32 {
     message("WARNING: hdf5: no support for 32 bit windows")
   ## 64bit
     INCLUDEPATH += $$VISIOCYTEMAINPATH/common_lib/include/hdf5-win64
     LIBS += -L$$VISIOCYTEMAINPATH/common_lib/winlib64 -lhdf5 -lszip -lzlib
}

macx {
INCLUDEPATH += $$VISIOCYTEMAINPATH/common_lib/include/hdf5
LIBS += -L$$VISIOCYTEMAINPATH/common_lib/lib_mac64 -lhdf5 -lszip -lz
}

unix {
INCLUDEPATH += $$VISIOCYTEMAINPATH/common_lib/include/hdf5
LIBS += -L$$VISIOCYTEMAINPATH/common_lib/lib_unix64 -lhdf5 -lszip -lz -ldl
}
#Visiocyte headers and sources needed by the plugin
...
INCLUDEPATH += $$VISIOCYTEMAINPATH/basic_c_fun/customary_structs
INCLUDEPATH += $$VISIOCYTEMAINPATH
...
HEADERS += ../terafly/src/control/VISIOCYTEsubclasses.h
...
SOURCES += ../terafly/src/control/VISIOCYTEsubclasses.cpp
