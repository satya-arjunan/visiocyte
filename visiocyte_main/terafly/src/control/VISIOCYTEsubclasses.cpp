...
void myVisiocyteR_GLWidget::setZoomO(int zr)
{
...
void myVisiocyteR_GLWidget::setZoomO(float zr)
{
...
void myVisiocyteR_GLWidget::wheelEventO(QWheelEvent *event)
{
...
//zoomIn method(s)
void myVisiocyteR_GLWidget::zoomIn(const char* method)
{
    ...
    if(strcmp(method, "Virtual Finger (bVF)") == 0)
    {
        ...
        visiocyte_imaging_paras* roi = new visiocyte_imaging_paras;
        roi->ops_type = 2;
        ...
        if(CViewer::getCurrent())
            CViewer::getCurrent()->invokedFromVisiocyte(roi);
...
void myVisiocyteR_GLWidget::updateImageDataFast()
{
