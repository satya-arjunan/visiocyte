...
struct terafly::annotation
{
    ...
    int subtype;                    //see Visiocyte LocationSimple and NeuronSWC types
    ...
    int visiocyte_n;                    //Visiocyte's swc/apo index
...
class terafly::CAnnotations
{
    ...
    public:
        ...
        **********************************************************************************/
        ...
        bool Sort_SWC(QList<NeuronSWC> & neurons, QList<NeuronSWC> & result, VISIOCYTELONG newrootid=-1);
        bool Sort_SWC_NewVersion(QList<NeuronSWC> & neurons, QList<NeuronSWC> & result,VISIOCYTELONG newrootid=-1);
        /*********************************************************************************
