...
class mozak::Mozak3DView : protected teramanager::CViewer
{
	...
	protected:
		...
		***************************************************************************************/
		Mozak3DView(VISIOCYTEPluginCallback2 *_VISIOCYTE_env, int _resIndex, itm::uint8 *_imgData, int _volV0, int _volV1,
		...
		~Mozak3DView();
        virtual teramanager::CViewer* makeView(VISIOCYTEPluginCallback2 *_VISIOCYTE_env, int _resIndex, itm::uint8 *_imgData, int _volV0, int _volV1,
			int _volH0, int _volH1, int _volD0, int _volD1, int _volT0, int _volT1, int _nchannels, itm::CViewer *_prev, int _slidingViewerBlockID);
		virtual void onNeuronEdit();
        void autoSave();
		void updateRendererParams();
		void makeTracedNeuronsEditable();
        VISIOCYTELONG findNearestNeuronNode(int cx, int cy, bool updateStartType=false);
	...
	public:
		...
		int neuronColorMode; // 0: Visiocyte EditNeuron colors;  1: Mozak colorByAncestry; 2: Visiocyte neuron type colors; 3: BRL review colors;
		...
		static const VISIOCYTELONG NUM_POLY_AUTO_Z_PLANES = 13;
	...
	public slots:
		...
		void updateColorMode(int colorMode);// 0: Visiocyte EditNeuron colors;  1: Mozak colorByAncestry; 2: Visiocyte neuron type colors; 3: BRL review colors;
		/*********************************************************************************
