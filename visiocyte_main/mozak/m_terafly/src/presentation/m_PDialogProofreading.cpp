...
itm::PDialogProofreading::PDialogProofreading(itm::PMain *_parent) : QWidget(0)
{
    ...
    QLabel *instructionsLabel = new QLabel("TeraFly will guide you through a stoppable/resumable block-by-block scan of the entire """
                                           ...
                                           "Use the settings below and the Visiocyte and TeraFly controls (e.g. Visiocyte volume cut scrollbars, TeraFly's 3D viewer max dims) to set up your proofreading session.");
...
bool itm::PDialogProofreading::eventFilter(QObject *obj, QEvent *evt)
{
    if(obj == VOI_field && evt->type()==QEvent::Enter)
    {
        ...
        QToolTip::showText(gpos, "To modify this, use Visiocyte volume cut scrollbars", VOI_field);
    }
