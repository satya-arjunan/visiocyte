...
PAbout::PAbout(QWidget *parent) : QDialog(parent)
{
    ...
    desc = new QLabel();
    desc->setText( QString("<html><h3>Visiocyte-TeraFly v. ").append(teramanager::version.c_str()).append("</h3>"
                         "<p>A tool designed for Teravoxel-sized datasets 3D navigation and Visiocyte-aided analysis.</p>"
    ...
    /*msgBox->setText( QString("<html><h1>TeraFly plugin v. ").append(CPlugin::getMajorVersion().c_str()).append("</h1>"
                    "<big>An experimental tool designed for Teravoxel-sized datasets 3D navigation into Visiocyte.</big><br><br>"
                    "<u>Developed by:</u><ul>"
