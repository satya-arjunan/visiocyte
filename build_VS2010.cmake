...
if [ $PLATFORM = "windows-x86_64" ]; then
    CMAKE_PLATFORM_ARGS+="-DTIFF_INCLUDE_DIR:PATH=$ROOT_DIR/visiocyte_main/common_lib/include "
    CMAKE_PLATFORM_ARGS+="-DTIFF_LIBRARY:PATH=$ROOT_DIR/visiocyte_main/common_lib/winlib64/libtiff.lib "
    CMAKE_PLATFORM_ARGS+="-DFFTW_INCLUDE_DIR:PATH=$ROOT_DIR/visiocyte_main/common_lib/fftw-3.3.4-dll64 "
    CMAKE_PLATFORM_ARGS+="-DFFTW_LIBRARY:PATH=$ROOT_DIR/visiocyte_main/common_lib/fftw-3.3.4-dll64/libfftw3f-3.lib"
fi
    ...
    install)
        ...
        if [[ ! -e $boost_prefix/include ]]; then
            ...
            if [ $PLATFORM = "windows-x86_64" ]; then
                ...
                tar xvf $ROOT_DIR/visiocyte_main/common_lib/src_packages/boost_$BOOST_VERSION.tar.gz
                cd boost_$BOOST_VERSION
        ...
        if [ $PLATFORM = "windows-x86_64" ]; then
          if [[ ! -e $ROOT_DIR/visiocyte_main/common_lib/include/tiff.h ]]; then
              echo "Configuring TIFF headers"
              cd $ROOT_DIR/visiocyte_main/common_lib/build
            ...
            echo "Unpacking FFTW"
            CMAKE_EXE+=" -G \"Visual Studio 10 2010 Win64\""
            cd $ROOT_DIR/visiocyte_main/common_lib
