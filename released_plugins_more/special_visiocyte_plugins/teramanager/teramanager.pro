...
#set up Visiocyte stuff needed by the plugin
win32{
    ...
    VISIOCYTEBUILDPATH = ./
    INCLUDEPATH += $$VISIOCYTEBUILDPATH/visiocyte
    INCLUDEPATH += $$VISIOCYTEBUILDPATH/visiocytebase

    #libtiff API
    INCLUDEPATH += $$VISIOCYTEMAINPATH/common_lib/src_packages/tiff-4.0.1/libtiff
    ...
    #Visiocyte libraries are compiled using the multithread-DLL version of the run-time library
...
#Visiocyte sources needed to use experimental features
use_experimental_features{
    ...
    SOURCES += $$VISIOCYTEMAINPATH/3drenderer/renderer.cpp
    SOURCES += $$VISIOCYTEMAINPATH/3drenderer/GLee_r.c
    SOURCES += $$VISIOCYTEMAINPATH/3drenderer/renderer_hit.cpp
    SOURCES += $$VISIOCYTEMAINPATH/visiocyte/landmark_property_dialog.cpp
    SOURCES += $$VISIOCYTEMAINPATH/visiocyte/surfaceobj_geometry_dialog.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat1.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat2.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat3.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat4.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat5.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat6.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat7.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat8.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmat9.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/newmatex.cpp
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/bandmat.cpp       # @ADDED by Alessandro on 2014-03-29: fixed "Failed instantiation" error on Ubuntu 13.10
    SOURCES += $$VISIOCYTEMAINPATH/jba/newmat11/myexcept.cpp      # @ADDED by Alessandro on 2014-03-29: fixed "Failed instantiation" error on Ubuntu 13.10
    SOURCES += $$VISIOCYTEMAINPATH/3drenderer/visiocyter_glwidget.cpp

    #WARNING! win32 moc*.cxx files locations might be different on your machine!
    win32{
        SOURCES += $$VISIOCYTEBUILDPATH/3drenderer/moc_visiocyter_glwidget.cxx
        SOURCES += $$VISIOCYTEBUILDPATH/visiocyte/moc_landmark_property_dialog.cxx
        SOURCES += $$VISIOCYTEBUILDPATH/visiocytebase/__/visiocyte/moc_surfaceobj_geometry_dialog.cxx
        SOURCES += $$VISIOCYTEBUILDPATH/visiocytebase/__/visiocyte/moc_surfaceobj_annotation_dialog.cxx
    }
    else{
        SOURCES += $$VISIOCYTEMAINPATH/visiocyte/moc_visiocyter_glwidget.cpp
        SOURCES += $$VISIOCYTEMAINPATH/visiocyte/moc_landmark_property_dialog.cpp
        SOURCES += $$VISIOCYTEMAINPATH/visiocyte/moc_surfaceobj_geometry_dialog.cpp
        SOURCES += $$VISIOCYTEMAINPATH/visiocyte/moc_surfaceobj_annotation_dialog.cpp
    }

    #undefined symbols referenced from Visiocyte objects are ignored and checked dynamically at execution time
    mac{
...
HEADERS += ./src/control/VISIOCYTEsubclasses.h
...
SOURCES += ./src/control/VISIOCYTEsubclasses.cpp
