...
int main (int argc, char *argv[])
{
	...
	//initialize the data buffer
	{
		...
		VISIOCYTELONG totalsz_input = sz_input[0]*sz_input[1]*sz_input[2]*sz_input[3];
		if (datatype_input==1 || datatype_input==2 || datatype_input==4)
		{
			try
			{
				img_output = new unsigned char [(VISIOCYTELONG)sz_output[0]*sz_output[1]*sz_output[2]*sz_output[3]*datatype_input]();
			}
			catch (...)
			{
...
//
//		for (VISIOCYTELONG z=0; z<sz_output[2]; z++)
//		{
//			for (VISIOCYTELONG j=0; j<sz_output[1]; j++)
//			{
//				for (VISIOCYTELONG i=0; i<sz_output[0]; i++)
//				{
//					for (VISIOCYTELONG cc=0;cc<sz_input[3]; cc++)
