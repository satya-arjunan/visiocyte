...
CC_FLAGS += $(patsubst %,-I%,$(subst ;, ,$(VPATH))) $(patsubst %,-L%,$(subst ;, ,$(VPATH))) -I../../../../visiocyte_main/common_lib/include
ifneq ($(strip $(ARCH_x86_64)),)
#LIBS = $(patsubst -ltiff,-L$(L_PATH) -ltiff64,$(LIBS))
LIBS += -L. -L$(L_PATH) -ltiff64 -lz -L../../../../visiocyte_main/common_lib/lib
else
LIBS += -L. -L../../../../visiocyte_main/common_lib/lib -ltiff 
endif
CC = g++
...
SHARED_FUNC_DIR = ../../../../visiocyte_main/basic_c_fun/
SHARED_BDB_DIR = ../../../../visiocyte_main/worm_straighten_c/
