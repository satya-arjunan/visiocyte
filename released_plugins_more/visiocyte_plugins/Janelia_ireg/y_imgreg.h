...
void absoluteOrientation(Y_IMG_S f, Y_IMG_T g, Y_MAT_D &R)
{
    ...
    ///
    cout<<"V ... pre ..."<<endl;
    for(VISIOCYTELONG i=0; i<V.column; i++)
    {
        for(VISIOCYTELONG j=0; j<V.row; j++)
        {
            cout<<" "<<V.v[i][j];
        }
        cout<<endl;
    ...
    ///
    cout<<"S ... pre ..."<<endl;
    for(VISIOCYTELONG i=0; i<S.column; i++)
    {
        for(VISIOCYTELONG j=0; j<S.row; j++)
        {
            cout<<" "<<S.v[i][j];
        }
        cout<<endl;
...
void Y_IREG<Tdata, Tidx, Y_IMG_S, Y_IMG_T, Y_IMG_D> :: lmregistration(Y_IMG_D &pOut, Y_IMG_S pS, Y_IMG_T pT, Y_LANDMARK lmS, Y_LANDMARK lmT)
{
    ...
    for(VISIOCYTELONG i=0; i<WA.column; i++)
    {
        for(VISIOCYTELONG j=0; j<WA.row; j++)
        {
            cout<<" "<<WA.v[i][j];
        }
        cout<<endl;
