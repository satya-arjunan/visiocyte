...
void IRegPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback2 &callback, QWidget *parent)
{
    ...
    else if (menu_name == tr("NiftiImageImporter"))
    {
        ...
        {
            p4DImage.setData((unsigned char*)pData, sx, sy, sz, sc, VISIOCYTE_UINT8);
        }
        else if(datatype == USHORT || datatype == SHORT)
        {
            p4DImage.setData((unsigned char*)pData, sx, sy, sz, sc, VISIOCYTE_UINT16);
        }
        else if(datatype == FLOAT)
        {
            p4DImage.setData((unsigned char*)pData, sx, sy, sz, sc, VISIOCYTE_FLOAT32);
        }
        else
        {
...
{
    printf("\nUsage: visiocyte -x ireg -f ireg -i <input_image> -o <output_image> -p \"#cs <subject_refchannel> #ct <target_refchannel>\"\n");
}

void errorPrint_globalalign()
{
    printf("\nUsage: visiocyte -x ireg -f globalalign -o <output_name> -p \"#s <subject_image> #cs <subject_refchannel> #t <target_image> #ct <target_refchannel>\"\n");
}

void errorPrint_rigidreg()
{
    printf("\nUsage: visiocyte -x ireg -f rigidreg -o <output_name> -p \"#s <subject_image> #cs <subject_refchannel> #t <target_image> #ct <target_refchannel>\"\n");
}

void errorPrint_evalAlignQuality()
{
    printf("\nUsage: visiocyte -x ireg -f evalAlignQuality -o <output_name> -p \"#s <subject_image> #cs <subject_refchannel> #t <target_image> #ct <target_refchannel>\"\n");
}

void errorPrint_localalign()
{
    printf("\nUsage: visiocyte -x ireg -f localalign -o <output_name> -p \"#s <subject_image> #cs <subject_refchannel> #t <target_image> #ct <target_refchannel>\"\n");
}

void errorPrint_iwarp()
{
    printf("\nUsage: visiocyte -x ireg -f iwarp -i <input_image> -o <output_image> -p \"#s <subject_image> #t <target_image> #a <affinematrix.txt> #d <displacementfields>\"\n");
}

void errorPrint_NiftiImageConverter()
{
    printf("\nUsage: visiocyte -x ireg -f NiftiImageConverter -i <input_image> -o <output_image> -p \"#b <0/1> #v <bit_width> #r <rescale>\"\n");
    printf("\nExample: ./visiocyte -x ireg -f NiftiImageConverter -i XX.tif -o XX.nii");
    printf("\n         ./visiocyte -x ireg -f NiftiImageConverter -i XX_c1.nii XX_c2.nii XX_c3.nii -o XX.visiocyteraw -p \"#b 1\"\n\n");
}
...
bool IRegPlugin::dofunc(const QString & func_name, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, VISIOCYTEPluginCallback2 & callback,  QWidget * parent)
{
    ...
    else if (func_name == tr("globalalign"))
    {
        ...
        // init
        VISIOCYTELONG channel_ref_tar = 0;
        VISIOCYTELONG channel_ref_sub = 0;
        ...
        if(paras)
        {
            ...
            if(outfile)
            {
                ...
                qs_filename_warped=qs_pathname_output+"/"+qs_basename_output+"Warped.visiocyteraw";
                qs_filename_deformed=qs_pathname_output+"/"+qs_basename_output+"Deformed.visiocyteraw";
            }
            else
            {
                ...
                qs_filename_warped=qs_pathname_input+"/"+qs_basename_input+"Warped.visiocyteraw";
                qs_filename_deformed=qs_pathname_input+"/"+qs_basename_input+"Deformed.visiocyteraw";
            }
        ...
        VISIOCYTELONG *sz_img_tar_input=0,*sz_img_sub_input=0;
        ...
        if(!loadImage((char *)qPrintable(qs_filename_img_tar),p_img_tar_input,sz_img_tar_input,datatype_tar_input))
        {
            ...
            y_del2<unsigned char, VISIOCYTELONG>(p_img_tar_input, sz_img_tar_input);
            return false;
        }
        ...
        {
            printf("ERROR: loadImage() return false in loading [%s].\n", qPrintable(qs_filename_img_sub));
            y_del2<unsigned char, VISIOCYTELONG>(p_img_sub_input, sz_img_sub_input);
            return false;
        }
        ...
        // reference channels
        VISIOCYTELONG offsets_sub = channel_ref_sub*sz_img_sub_input[0]*sz_img_sub_input[1]*sz_img_sub_input[2];
        VISIOCYTELONG offsets_tar = channel_ref_tar*sz_img_tar_input[0]*sz_img_tar_input[1]*sz_img_tar_input[2];

        p_sub = p_img_sub_input+offsets_sub*datatype_sub_input;
        p_tar = p_img_tar_input+offsets_tar*datatype_tar_input;

        VISIOCYTELONG *sz_sub=NULL, *sz_tar=NULL;
        y_new<VISIOCYTELONG, VISIOCYTELONG>(sz_sub, 4);
        y_new<VISIOCYTELONG, VISIOCYTELONG>(sz_tar, 4);
        ...
        // affine matrix
        VISIOCYTELONG *sz_affine=NULL;
        y_new<VISIOCYTELONG, VISIOCYTELONG>(sz_affine, 4);
        ...
        //
        Scale<REAL, VISIOCYTELONG> scale;
        scale.setSampleRatio3D(0.125, 0.125, 0.125);
        scale.setIterations(300); //

        vector< Scale<REAL, VISIOCYTELONG> > multiscales;
        ...
        if(datatype_tar_input==1)
        {
            ...
            if(datatype_sub_input==1)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8, Y_IMG_REAL> globalalign;
                ...
                if(b_save_warped)
                {
                    ...
                    warp<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_REAL, Y_IMG_REAL>(pSDeformedD, pSub, pOut, globalalign.opt);
                }
            ...
            else if(datatype_sub_input==2)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT8, Y_IMG_REAL> globalalign;
                ...
                if(b_save_warped)
                {
                    ...
                    warp<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_REAL, Y_IMG_REAL>(pSDeformedDTmp, pSub, pOut, globalalign.opt);

                    foreach(pTar.totalplxs, i)
                        pSDeformedD.pImg[i] = pSDeformedDTmp.pImg[i]; //

                    // flip
                    Y_MAT<REAL, VISIOCYTELONG> F(pOutFlip.pImg, pOutFlip.dims[0], pOutFlip.dims[1]); // 3D A4x4

                    if(F.v[0][0]==-1)
                    {
                        flip<REAL, VISIOCYTELONG>(pSDeformedD.pImg, pSDeformedDTmp.pImg, pSDeformedDTmp.dims, AX); // x
                        foreach(pTar.totalplxs, i)
                    ...
                    if(F.v[1][1]==-1)
                    {
                        flip<REAL, VISIOCYTELONG>(pSDeformedD.pImg, pSDeformedDTmp.pImg, pSDeformedDTmp.dims, AY); // y
                        foreach(pTar.totalplxs, i)
                            pSDeformedDTmp.pImg[i] = pSDeformedD.pImg[i]; //
                    }
                    ...
                    if(F.v[2][2]==-1)
                    {
                        flip<REAL, VISIOCYTELONG>(pSDeformedD.pImg, pSDeformedDTmp.pImg, pSDeformedDTmp.dims, AZ); // z
                    }
            ...
            else if(datatype_sub_input==4)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_REAL, Y_IMG_UINT8, Y_IMG_REAL> globalalign;
                ...
                if(b_save_warped)
                {
                    ...
                    warp<VISIOCYTELONG, Y_IMG_REAL, Y_IMG_REAL, Y_IMG_REAL>(pSDeformedD, pSub, pOut, globalalign.opt); // pOut is affine matrix
                }
            }
            else
            {
        ...
        else if(datatype_tar_input==2)
        {
            ...
            if(datatype_sub_input==1)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT16, Y_IMG_REAL> globalalign;
            ...
            else if(datatype_sub_input==2)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT16, Y_IMG_REAL> globalalign;
                ...
                if(b_save_warped)
                {
                    ...
                    warp<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_REAL, Y_IMG_REAL>(pSDeformedD, pSub, pOut, globalalign.opt);
                }
            }
            else if(datatype_sub_input==4)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_REAL, Y_IMG_UINT16, Y_IMG_REAL> globalalign;
        ...
        else if(datatype_tar_input==4)
        {
            ...
            if(datatype_sub_input==1)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_REAL, Y_IMG_REAL> globalalign;
            ...
            else if(datatype_sub_input==2)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_REAL, Y_IMG_REAL> globalalign;
            ...
            else if(datatype_sub_input==4)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_REAL, Y_IMG_REAL, Y_IMG_REAL> globalalign;
        ...
        Y_MAT<REAL, VISIOCYTELONG> A(pOut.pImg, pOut.dims[0], pOut.dims[1]);
        qDebug()<<"affine matrix ...";
        for(VISIOCYTELONG i=0; i<A.column; i++)
        {
            for(VISIOCYTELONG j=0; j<A.row; j++)
            {
                cout<<" "<<A.v[i][j];
            }
            cout<<endl;
        ...
        if(b_save_warped)
        {
            if(qs_filename_deformed!=NULL)
            {
                ...
                normalizing<REAL, VISIOCYTELONG>(pSDeformedD.pImg, pSDeformedD.totalplxs, 0, 255);
        ...
        {
            // affine
            Y_AFFINETRANSFORM<REAL, VISIOCYTELONG> afftrans;
            ...
            // flip
            Y_AFFINETRANSFORM<REAL, VISIOCYTELONG> fliptrans;
        ...
        y_del<VISIOCYTELONG>(sz_affine);
        y_del<VISIOCYTELONG>(sz_sub);
        y_del<VISIOCYTELONG>(sz_tar);
    ...
    else if (func_name == tr("iwarp"))
    {
        ...
        if(paras)
        {
            ...
            if(outfile)
            {
                ...
                qs_filename_deformed=qs_pathname_output+"/"+qs_basename_output+".visiocyteraw";
            }
            else
            {
                qs_filename_deformed=qs_pathname_input+"/"+qs_basename_input+"_deformed.visiocyteraw";
            }
        ...
        if(qs_filename_affinematrix!=NULL && QFile(qs_filename_affinematrix).exists())
        {
            ...
            if(qs_filename_flipmatrix!=NULL && QFile(qs_filename_flipmatrix).exists())
            {
                ...
                //
                Y_MAT<REAL, VISIOCYTELONG> F1(pOutFlip.pImg, pOutFlip.dims[0], pOutFlip.dims[1]);
                F.assign(F1);
                F1.clean();
                qDebug()<<"flip matrix ...";
                for(VISIOCYTELONG i=0; i<F.column; i++)
                {
                    for(VISIOCYTELONG j=0; j<F.row; j++)
                    {
                        cout<<" "<<F.v[i][j];
                    }
                    cout<<endl;
            ...
            if(datatype_sub_input==1)
            {
                ...
                for(VISIOCYTELONG c=0; c<sz_tar[3]; c++)
                {
                    VISIOCYTELONG offset_sub = c*sz_sub[0]*sz_sub[1]*sz_sub[2];
                    VISIOCYTELONG offset_tar = c*sz_tar[0]*sz_tar[1]*sz_tar[2];

                    Y_IMG_UINT8 pSub;
                    pSub.setImage((unsigned char*)p_img_sub_input + offset_sub, sz_sub, 4);

                    // warp
                    warp<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8, Y_IMG_REAL>(pSDeformed1D, pSub, pOut, opt);
                    ...
                    if(b_flip)
                    {
                        ...
                        if(F.v[0][0]==-1)
                        {
                            flip<unsigned char, VISIOCYTELONG>(p, pSDeformed1D.pImg, pSDeformed1D.dims, AX); // x
                            foreach(pSDeformed1D.totalplxs, i)
                        ...
                        if(F.v[1][1]==-1)
                        {
                            flip<unsigned char, VISIOCYTELONG>(p, pSDeformed1D.pImg, pSDeformed1D.dims, AY); // y
                            foreach(pSDeformed1D.totalplxs, i)
                                pSDeformed1D.pImg[i] = p[i]; //
                        }
                        ...
                        if(F.v[2][2]==-1)
                        {
                            flip<unsigned char, VISIOCYTELONG>(p, pSDeformed1D.pImg, pSDeformed1D.dims, AZ); // z
                        }
                    }
                }
            ...
            else if(datatype_sub_input==2)
            {
                ...
                for(VISIOCYTELONG c=0; c<sz_tar[3]; c++)
                {
                    ...
                    // warp
                    warp<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT16, Y_IMG_REAL>(pSDeformed1Du16, pSub, pOut, opt);
                    ...
                    if(b_flip)
                    {
                        ...
                        if(F.v[0][0]==-1)
                        {
                            flip<unsigned short, VISIOCYTELONG>(p, pSDeformed1Du16.pImg, pSDeformed1Du16.dims, AX); // x
                            foreach(pSDeformed1Du16.totalplxs, i)
                        ...
                        if(F.v[1][1]==-1)
                        {
                            flip<unsigned short, VISIOCYTELONG>(p, pSDeformed1Du16.pImg, pSDeformed1Du16.dims, AY); // y
                            foreach(pSDeformed1Du16.totalplxs, i)
                                pSDeformed1Du16.pImg[i] = p[i]; //
                        }
                        ...
                        if(F.v[2][2]==-1)
                        {
                            flip<unsigned short, VISIOCYTELONG>(p, pSDeformed1Du16.pImg, pSDeformed1Du16.dims, AZ); // z
                        }
                    }
                }
            }
            else if(datatype_sub_input==4)
            {
                ...
                // warp
                // warp<VISIOCYTELONG, Y_IMG_REAL, Y_IMG_UINT8, Y_IMG_REAL>(pSDeformed1D, pSub, pOut, opt);
            }
            else
            {
                printf("Currently this program only support UINT8, UINT16, and FLOAT32 datatype.\n");
        ...
        if(qs_filename_warped!=NULL && QFile(qs_filename_warped).exists())
        {
            ...
            //
            VISIOCYTELONG dfsx, dfsy, dfsz, dfsc;
            int dfdatatype;
            void *pDF = 0;
            ...
            VISIOCYTELONG *szdf=NULL;
            y_new<VISIOCYTELONG, VISIOCYTELONG>(szdf, 4);
            ...
            if(dfdatatype == UCHAR || dfdatatype == CHAR)
            {
                ...
                VISIOCYTELONG pagesz = dfsx*dfsy*dfsz;

                for(VISIOCYTELONG k=0; k<dfsz; k++)
                {
                    VISIOCYTELONG offset_k = k*dfsx*dfsy;
                    VISIOCYTELONG offset_k_df = k*dfsx*dfsy*dfsc;
                    for(VISIOCYTELONG j=0; j<dfsy; j++)
                    {
                        VISIOCYTELONG offset_j = offset_k + j*dfsx;
                        VISIOCYTELONG offset_j_df = offset_k_df + j*dfsx*dfsc;
                        for(VISIOCYTELONG i=0; i<dfsx; i++)
                        {
                            for(VISIOCYTELONG c=0; c<dfsc; c++)
                            {
            ...
            if(datatype_sub_input==1)
            {
                for(VISIOCYTELONG c=0; c<sz_tar[3]; c++)
                {
                    VISIOCYTELONG offsets = c*sz_tar[0]*sz_tar[1]*sz_tar[2];
                    ...
                    interpolation<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8, Y_IMG_REAL>(pSDeformed1D, pSub, df, opt);
    ...
    else if (func_name == tr("iwarp2"))
    {
        ...
        // DIMENSIONS
        VISIOCYTELONG tx=0.0,ty=0.0,tz=0.0;
        ...
        if(qs_filename_affinematrix!=NULL && QFile(qs_filename_affinematrix).exists())
        {
            ...
            if(datatype_sub_input==1)
            {
                ...
                VISIOCYTELONG pagesztar=sz_tar[0]*sz_tar[1]*sz_tar[2];
                VISIOCYTELONG pageszsub=sz_sub[0]*sz_sub[1]*sz_sub[2];
                ...
                for(VISIOCYTELONG c=0; c<sz_tar[3]; c++)
                {
                    ...
                    // warp
                    warp2<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8, Y_IMG_REAL>(pSDeformed1D, pSub, pOut, srx, sry, srz, opt);
            ...
            else if(datatype_sub_input==2)
            {
                ...
                for(VISIOCYTELONG c=0; c<sz_tar[3]; c++)
                {
                    ...
                    // warp
                    warp2<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT16, Y_IMG_REAL>(pSDeformed1Du16, pSub, pOut, srx, sry, srz, opt);
    ...
    else if (func_name == tr("NiftiImageConverter"))
    {
        ...
        if(outfile)
        {
            ...
            else
            {
                ...
                qs_filename_img_output=qs_pathname_output+"/"+qs_basename_output+".visiocyteraw";
            }
        }
        else
        {
            ...
            {
                qs_filename_img_output=qs_pathname_output+"/"+qs_basename_input+".visiocyteraw";
            }
        }
        ...
        if(b_invert==0)
        {
            // convert .tif/.lsm/.visiocyteraw to .img/.nii

            // load image
            unsigned char *inputImg1d=NULL;
            VISIOCYTELONG *sz_inputImg=NULL;
            ...
            {
                VISIOCYTELONG offset_c = c*sx*sy*sz;
            ...
            for(int inputcnt=0; inputcnt<sc; inputcnt++)
            {
                ...
                if(sdatatype==DOUBLE && (szvxl==1 || szvxl==2) )
                {
                    if(szvxl==1)
                    {
                        ...
                        if(b_rescale==1)
                        {
                            rescaling<double, VISIOCYTELONG>(pNifti, pagesz, (double)0.0, (double)255.0);
                        }
                    ...
                    else if(szvxl==2)
                    {
                        ...
                        if(b_rescale==1)
                        {
                            rescaling<double, VISIOCYTELONG>(pNifti, pagesz, (double)0.0, (double)4095.0);
                        }
                ...
                else if(sdatatype==FLOAT && (szvxl==1 || szvxl==2) )
                {
                    if(szvxl==1)
                    {
                        ...
                        if(b_rescale==1)
                        {
                            rescaling<REAL, VISIOCYTELONG>(pNifti, pagesz, (REAL)0.0, (REAL)255.0);
                        }
                    ...
                    else if(szvxl==2)
                    {
                        ...
                        if(b_rescale==1)
                        {
                            rescaling<REAL, VISIOCYTELONG>(pNifti, pagesz, (REAL)0.0, (REAL)4095.0);
                        }
                ...
                else if((sdatatype == USHORT || sdatatype == SHORT) && szvxl==1 )
                {
                    if(sdatatype == USHORT)
                    {
                        ...
                        if(b_rescale==1)
                        {
                            rescaling<unsigned short, VISIOCYTELONG>(pNifti, pagesz, (unsigned short)0, (unsigned short)255);
                        }
                    ...
                    else if(sdatatype == SHORT)
                    {
                        ...
                        if(b_rescale==1)
                        {
                            rescaling<short, VISIOCYTELONG>(pNifti, pagesz, (short)0, (short)255);
                        }
    ...
    else if (func_name == tr("splitColorChannels"))
    {
        ...
        if(outfile)
        {
            ...
            qs_filename_output=qs_pathname_output+"/"+qs_basename_output+".visiocyteraw";
        }
        else
        {
            qs_filename_output=qs_pathname_input+"/"+qs_basename_input+".visiocyteraw";
        }
        ...
        for(VISIOCYTELONG c=0; c<sc; c++)
        {
            ...
            qs_filename_img_output=qs_pathname_output+"/"+qs_basename_output+QString("_c%1.visiocyteraw").arg(c);
        ...
        y_del<VISIOCYTELONG>(sz_inputImg);
    ...
    else if (func_name == tr("mergeColorChannels"))
    {
        ...
        {
            //print Help info
            cout<<"Usage: visiocyte -x ireg -f mergeColorChannels -i <inputs> -o <output>"<<endl;
            return true;
        }
        ...
        for(int c=0; c<sc; c++)
        {
            ...
            if(c==0)
            {
                ...
                y_new<unsigned char, VISIOCYTELONG>(pOutput, sx*sy*sz*sc*datatype_output);
        ...
        // write image(s)
        sz_inputImg[3] = sc;
        if(datatype_output==VISIOCYTE_UINT8)
        {
        ...
        else if(datatype_output==VISIOCYTE_UINT16)
        {
        ...
        else if(datatype_output==VISIOCYTE_FLOAT32)
        {
    ...
    else if (func_name == tr("zflip"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f zflip -i <input> -o <output> \n");
            return true;
        }
        ...
        if(QFileInfo(qs_filename_img_input).suffix().toUpper().compare("LSM") == 0)
        {
            ...
            if(loadTif2StackMylib(const_cast<char *>(qs_filename_img_input.toStdString().c_str()), p1dImg, sz_img, datatype_img, pixelnbits))
            {
                ...
                y_del2<unsigned char, VISIOCYTELONG>(p1dImg, sz_img);
                return false;
            }
        }
        else
        ...
        //
        VISIOCYTELONG pagesz = sz_img[0]*sz_img[1]*sz_img[2];
        VISIOCYTELONG totalplxs = pagesz * sz_img[3];

        /// flip along z
        unsigned char *p_flip = NULL;
        y_new<unsigned char, VISIOCYTELONG>(p_flip, totalplxs*datatype_img);
        ...
        foreach(sz_img[3], c)
        {
            if(datatype_img == 1)
            {
                ...
                flip<unsigned char, VISIOCYTELONG>(poutput, pinput, sz_img, AZ); // z
            }
            else if(datatype_img == 2)
            {
                ...
                flip<unsigned short, VISIOCYTELONG>(poutput, pinput, sz_img, AZ); // z
            }
            else
            {
    ...
    else if (func_name == tr("xflip"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f xflip -i <input> -o <output> \n");
            return true;
        }
        ...
        foreach(sz_img[3], c)
        {
            if(datatype_img == 1)
            {
                ...
                flip<unsigned char, VISIOCYTELONG>(poutput, pinput, sz_img, AX); // x
            }
            else if(datatype_img == 2)
            {
                //
                ...
                flip<unsigned short, VISIOCYTELONG>(poutput, pinput, sz_img, AX); // x
            }
            else
            {
                cout<<"your datatype is not supported!"<<endl;
    ...
    else if (func_name == tr("yflip"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f yflip -i <input> -o <output> \n");
            return true;
        }
        ...
        foreach(sz_img[3], c)
        {
            if(datatype_img == 1)
            {
                ...
                flip<unsigned char, VISIOCYTELONG>(poutput, pinput, sz_img, AY); // y
            }
            else if(datatype_img == 2)
            {
                //
                ...
                flip<unsigned short, VISIOCYTELONG>(poutput, pinput, sz_img, AY); // y
            }
            else
            {
                cout<<"your datatype is not supported!"<<endl;
    ...
    else if (func_name == tr("zmip"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f zmip -i <input> -o <output> \n");
            return true;
        }
...
//            qs_filename_output=qs_pathname_output+"/"+qs_basename_output+".visiocyteraw";
        ...
        y_new<unsigned char, VISIOCYTELONG>(p_mip, totalplxs/sz_img[2]);

        VISIOCYTELONG sz = sz_img[2];
        sz_img[2] = 1;

        foreach(sz_img[3], c)
        {
            VISIOCYTELONG offsetz = sz_img[0]*sz_img[1];
            ...
            if(datatype_img == 1)
            {
                ...
                for(VISIOCYTELONG j=0; j<sz_img[1]; j++)
                {
                    VISIOCYTELONG offset_j = j*sz_img[0];
                    for(VISIOCYTELONG i=0; i<sz_img[0]; i++)
                    {
                        VISIOCYTELONG idx = offset_j + i;
                        unsigned char val = pinput[idx];

                        for(VISIOCYTELONG k=1; k<sz; k++)
                        {
                ...
                y_new<unsigned char, VISIOCYTELONG>(ptmp, offsetz);
            ...
            else if(datatype_img == 2)
            {
                ...
                flip<unsigned char, VISIOCYTELONG>(poutput, p_input, sz_img, AY); // y
    ...
    else if (func_name == tr("prepare40xData"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f prepare40xData -o <output> -p \"#s <subject> #t <target>\"!\n");
            return true;
        }
        ...
        if(QFileInfo(qs_filename_img_tar).suffix().toUpper().compare("LSM") == 0)
        {
            ...
            {
                printf("ERROR: loadImage() fails.\n");
                y_del2<unsigned char, VISIOCYTELONG>(p1dImg1, sz_img1);
                return false;
            }
        }
        else
        ...
        if(QFileInfo(qs_filename_img_sub).suffix().toUpper().compare("LSM") == 0)
        {
            ...
            {
                printf("ERROR: loadImage() fails.\n");
                y_del2<unsigned char, VISIOCYTELONG>(p1dImg2, sz_img2);
                return false;
            }
        }
        else
        ...
        /// convert sub to 8bit
        unsigned char *p_sub=NULL;
        VISIOCYTELONG sx = sz_img2[0];
        VISIOCYTELONG sy = sz_img2[1];
        VISIOCYTELONG sz = sz_img2[2];
        VISIOCYTELONG sc = sz_img2[3];
        VISIOCYTELONG pagesz = sx*sy*sz;
        VISIOCYTELONG totalplxs = pagesz*sc;
        ...
        else if(datatype_img2==UINT16)
        {
            ...
            rescaling<unsigned short, VISIOCYTELONG>(p, totalplxs, 0, 255);

            y_new<unsigned char, VISIOCYTELONG>(p_sub, totalplxs);
            foreach(totalplxs, i)
                p_sub[i] = p[i];
        ...
        else if(datatype_img2==FLOAT32)
        {
            ...
            rescaling<float, VISIOCYTELONG>(p, totalplxs, 0.0f, 255.0f);
        ...
        VISIOCYTELONG *szds=NULL;

        y_new<VISIOCYTELONG, VISIOCYTELONG>(szds, 4);
        ...
        VISIOCYTELONG pageszds = sx*sy*sz;
        VISIOCYTELONG totalplxsds = pagesz*sc;

        y_new<unsigned char, VISIOCYTELONG>(p_subds, totalplxsds);

        //
        VISIOCYTELONG *sz_sub=NULL, *sz_subds=NULL;

        y_new<VISIOCYTELONG, VISIOCYTELONG>(sz_sub, 4);
        y_new<VISIOCYTELONG, VISIOCYTELONG>(sz_subds, 4);
        ...
        foreach(sc, c)
        {
            ...
            resize<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8>(pOut, pIn, SAMPLE);
        }
        ...
        y_new<unsigned char, VISIOCYTELONG>(p_subdsrec, totalplxs);
        ...
        foreach(sc, c)
        {
            ...
            resize<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8>(pOut, pIn, IMCENTER);
        }

        // de-alloc
        y_del<unsigned char>(p_subds);
        y_del<VISIOCYTELONG>(sz_subds);

        //
        /// flip along z
        unsigned char *p_subdsrecflip = NULL;
        y_new<unsigned char, VISIOCYTELONG>(p_subdsrecflip, totalplxs);
        ...
        foreach(sc, c)
        {
            ...
            flip<unsigned char, VISIOCYTELONG>(poutput, pinput, sz_img1, AZ); // z
        }
    ...
    else if (func_name == tr("prepare20xData"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f prepare20xData -o <output> -p \"#s <subject> #t <target> #k <keepinputdatatype>\"!\n");
            return true;
        }
        ...
        if(paras)
        {
            ...
            if(outfile)
            {
                ...
                if(!(QFileInfo(qs_filename_output).suffix().toUpper().compare("TIF") == 0
                     || QFileInfo(qs_filename_output).suffix().toUpper().compare("VISIOCYTERAW") == 0))
                {
                    QString qs_pathname_output=QFileInfo(qs_filename_output).path();
                    QString qs_basename_output=QFileInfo(qs_filename_output).baseName();
        ...
        unsigned char *p_sub=NULL;
        VISIOCYTELONG sc = sz_img2[3];
        VISIOCYTELONG totalplxs_sub = sz_img2[0]*sz_img2[1]*sz_img2[2]*sc;
        ...
        else if(datatype_img2==UINT16)
        {
            ...
            if(!keepdatatype)
            {
                rescaling<unsigned short, VISIOCYTELONG>(p, totalplxs_sub, 0, 255);

                y_new<unsigned char, VISIOCYTELONG>(p_sub, totalplxs_sub);
                foreach(totalplxs_sub, i)   p_sub[i] = p[i];
            }
            else
            {
                y_new<unsigned char, VISIOCYTELONG>(p_sub, totalplxs_sub*2);
        ...
        else if(datatype_img2==FLOAT32)
        {
            //
            float *p = (float *)p1dImg2;
            rescaling<float, VISIOCYTELONG>(p, totalplxs_sub, 0.0f, 255.0f);
        ...
        /// resize
        sz_img1[3] = sc;
        VISIOCYTELONG pagesz = sz_img1[0]*sz_img1[1]*sz_img1[2];
        VISIOCYTELONG totalplxs = pagesz*sz_img1[3];
        ...
        {
            //
            y_new<unsigned char, VISIOCYTELONG>(p_subrec, totalplxs);
            ...
            resizeMC<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8>(pOut, pIn, channel_ref_sub);
        ...
        else if(datatype_img2==UINT16)
        {
            ...
            //
            y_new<unsigned char, VISIOCYTELONG>(p_subrec, totalplxs*2);
            ...
            resizeMC<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT16>(pOut, pIn, channel_ref_sub);
    ...
    else if (func_name == tr("resizeImage"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f resizeImage -o <output> -p \"#s <subject> #t <target> #k <keepinputdatatype>\"!\n");
            return true;
        }
        ...
        if(!keepdatatype || datatype_img2==UINT8) // 8-bit
        {
            ...
            resizeImage<unsigned char, VISIOCYTELONG, Y_IMG_UINT8>(pOut, pIn, b_interptype, b_skipsampling);
        ...
        else if(datatype_img2==UINT16)
        {
            ...
            resizeImage<unsigned short, VISIOCYTELONG, Y_IMG_UINT16>(pOut, pIn, b_interptype, b_skipsampling);
    ...
    else if (func_name == tr("MultiLabelImageConverter"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f MultiLabelImageConverter -i <input> -o <output> -p \"#b <1/2/4>\"!\n");
            return true;
        }
        ...
        unsigned char *p_sub=NULL;
        VISIOCYTELONG totalplxs_sub = sz_img1[0]*sz_img1[1]*sz_img1[2]*sz_img1[3];
        ...
        if(datatype_img1==UINT8)
        {
            ...
            {
                y_new<unsigned char, VISIOCYTELONG>(p_sub, totalplxs_sub*outputbyte);
    ...
    else if (func_name == tr("isampler"))
    {
        ...
        if(input.size()<1) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f isampler -o <output> -p \"#x <sample_ratio_x> #y <sample_ratio_y> #z <sample_ratio_z> #i <interp_type>\"!\n");
            return true;
        }
        ...
        if(paras)
        {
            ...
            {
                qs_filename_output=qs_pathname_input+"/"+qs_basename_input+"_sampled.visiocyteraw";
            }
        ...
        VISIOCYTELONG *szResample=NULL;

        y_new<VISIOCYTELONG, VISIOCYTELONG>(szResample, 4);
        ...
        VISIOCYTELONG pagesz_input = sz_img1[0]*sz_img1[1]*sz_img1[2];
        VISIOCYTELONG pagesz = szResample[0]*szResample[1]*szResample[2];
        VISIOCYTELONG totalplxs = pagesz*szResample[3];
        VISIOCYTELONG cdims = szResample[3];

        //
        y_new<unsigned char, VISIOCYTELONG>(pResample, totalplxs*datatype_img1);
        ...
        foreach(cdims, c)
        {
            if(datatype_img1==UINT8)
            {
                ...
                {
                    // NN
                    resize<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8>(pOut, pIn, SAMPLENN);
                }
                else
                {
                    // Linear
            ...
            else if(datatype_img1==UINT16)
            {
                ...
                {
                    // NN
                    resize<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT16>(pOut, pIn, SAMPLENN);
                }
                else
                {
                    // Linear
                    resize<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT16>(pOut, pIn, SAMPLE);
                }
            ...
            else if(datatype_img1==FLOAT32)
            {
                ...
                {
                    // NN
                    resize<VISIOCYTELONG, Y_IMG_REAL, Y_IMG_REAL>(pOut, pIn, SAMPLENN);
                }
                else
                {
                    // Linear
                    resize<VISIOCYTELONG, Y_IMG_REAL, Y_IMG_REAL>(pOut, pIn, SAMPLE);
                }
        ...
        y_del<VISIOCYTELONG>(szResample);
    ...
    else if (func_name == tr("iContrastEnhancer"))
    {
        ...
        if(input.size()<1) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f iContrastEnhancer -i <input> -o <output> -p \"#s <block_size> #m <maximum_slope> #b <histogram_bins>\"!\n");
            return true;
        }
        ...
        VISIOCYTELONG sx = sz_img1[0];
        VISIOCYTELONG sy = sz_img1[1];

        VISIOCYTELONG ssx = sx;
        VISIOCYTELONG ssy = sy;
        ...
        VISIOCYTELONG i,j,k, offset, offset_r, offsety, offsety_r, pagesz = sx*sy;
        VISIOCYTELONG pages = sz_img1[2]*sz_img1[3];
        VISIOCYTELONG totalplxs = ssx*ssy*pages;
        ...
        if(datatype_img1==UINT8)
        {
            ...
            if(b_resize)
            {
                y_new<unsigned char, VISIOCYTELONG>(p, totalplxs);
        ...
        else if(datatype_img1==UINT16)
        {
            ...
            if(b_resize)
            {
                y_new<unsigned short, VISIOCYTELONG>(p, totalplxs);
                foreach(totalplxs, i) p[i] = 0;
    ...
    else if (func_name == tr("bwthinning"))
    {
        ...
        if(input.size()<1) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f bwthinning -i <input> -o <output> -p \"\"!\n");
            return true;
        }
        ...
        // init
        REAL maxslope = 3.0;
        VISIOCYTELONG szblock = 16;
        VISIOCYTELONG histbins = 256;
        ...
        if(datatype_img1==UINT8)
        {
            ...
            VISIOCYTELONG offset_y, offset_z;
            offset_y = sx;
            offset_z = offset_y*sy;
            VISIOCYTELONG pagesz = offset_z*sz;

            //
            unsigned char *pR = p1dImg1;
            unsigned char *pG = p1dImg1 + pagesz;

            VISIOCYTELONG neighbors[6] = {-1, 1, -offset_y, offset_y, -offset_z, offset_z};
            ...
            while(b_dothinning)
            {
                ...
                for(VISIOCYTELONG k=1; k<sz-1; k++)
                {
                    VISIOCYTELONG idxk = k*offset_z;
                    for(VISIOCYTELONG j=1; j<sy-1; j++)
                    {
                        VISIOCYTELONG idxj = idxk + j*offset_y;
                        for(VISIOCYTELONG i=1; i<sx-1; i++)
                        {
                            VISIOCYTELONG idx = idxj + i;
    ...
    else if (func_name == tr("lmreg"))
    {
        ...
        {
            //print Help info
            cout<<"Usage: visiocyte -x ireg -f lmreg -p \"#s <subject_image> #l <subject_markers> #t <target_image> #L <target_markers>\""<<endl;
            return true;
        }
        ...
        VISIOCYTELONG m = landmarkers_sub.size(); // assume the quantity markers same
        for(VISIOCYTELONG i=0; i<m; i++)
        {
            Y_MARKER<double> p;
        ...
        VISIOCYTELONG *sz_wa=NULL;
        y_new<VISIOCYTELONG, VISIOCYTELONG>(sz_wa, 4);
        ...
        if(datatype_tar_input==1)
        {
            ...
            if(datatype_sub_input==1)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8, Y_IMG_REAL> lmaligner;
                ...
                //
                warp<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_REAL, Y_IMG_REAL>(pSDeformedD, pSub, pOut, lmaligner.opt);
            ...
            else if(datatype_sub_input==2)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT8, Y_IMG_REAL> lmaligner;
                ...
                //
                warp<VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_REAL, Y_IMG_REAL>(pSDeformedD, pSub, pOut, lmaligner.opt);
            }
            else if(datatype_sub_input==4)
            {
        ...
        else if(datatype_tar_input==2)
        {
            ...
            if(datatype_sub_input==1)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT16, Y_IMG_REAL> lmaligner;
            ...
            else if(datatype_sub_input==2)
            {
                ...
                Y_IREG<REAL, VISIOCYTELONG, Y_IMG_UINT16, Y_IMG_UINT16, Y_IMG_REAL> lmaligner;
    ...
    else if (func_name == tr("QiScoreStas"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f QiScoreStas -o <output> -p \"#l <aligned_landmarks> #t <target_landmarks> #m <imagemask>\"!\n");
            return true;
        }
        ...
        VISIOCYTELONG m = landmarkers.size(); //
        ...
        if(qs_filename_tgt_marker!=NULL)
        {
            ...
            VISIOCYTELONG m_tgt = landmarkers_tgt.size(); //

            qDebug()<<"we have "<<m_tgt<<" markers of target! ";

            VISIOCYTELONG cb=0, lo=0, ro=0;

            for(VISIOCYTELONG i=0; i<m_tgt; i++)
            {
                VISIOCYTELONG z = landmarkers_tgt.at(i).z;
                VISIOCYTELONG y = landmarkers_tgt.at(i).y;
                VISIOCYTELONG x = landmarkers_tgt.at(i).x;

                if(z>sz-1){ z=sz-1;}
                if(y>sy-1){ y=sy-1;}
                if(x>sx-1){ x=sx-1;}

                VISIOCYTELONG idx = z * sx * sy + y * sx + x;
        ...
        //
        VISIOCYTELONG cntlo=0,cntcb=0,cntro=0;
        ...
        if(datatype_img1==UINT8)
        {
            ...
            for(VISIOCYTELONG i=0; i<m; i++)
            {
                ...
                VISIOCYTELONG z = lm.at(i).z;
                VISIOCYTELONG y = lm.at(i).y;
                VISIOCYTELONG x = lm.at(i).x;
    ...
    else if (func_name == tr("iSymmetryDet"))
    {
        ...
        {
            //print Help info
            printf("\nUsage: ./visiocyte -x ireg -f iSymmetryDet -i <input_image> -o <output_image>\n");
            return true;
        }
        ...
        if(outfile)
        {
            ...
            qs_output_img=qs_pathname_output+"/"+qs_basename_output+".visiocyteraw";
        }
        else
        {
            qs_output_img=qs_pathname_input+"/"+qs_basename_input+".visiocyteraw";
        }

        VISIOCYTELONG *szImg_input=NULL;
        ...
        if(!loadImage((char *)qPrintable(qs_input_img),pImg1d_input,szImg_input,datatype_input))
        {
            ...
            y_del2<unsigned char, VISIOCYTELONG>(pImg1d_input, szImg_input);
            return false;
        }
        ...
        //
        symmetryDet<VISIOCYTELONG, REAL, Y_IMG_REAL>(yImg, yLM);
        ...
        if(qs_output_img!=NULL)
        {
            ...
            normalizing<REAL, VISIOCYTELONG>(yImg.pImg, yImg.totalplxs, 0, 255);
            foreach(yImg.totalplxs, i)
    ...
    else if (func_name == tr("iRecenter"))
    {
        ...
        {
            //print Help info
            printf("\nUsage: ./visiocyte -x ireg -f iRecenter -i <input_image> -o <output_image>\n");
            return true;
        }
        ...
        //
        resize<VISIOCYTELONG, Y_IMG_UINT8, Y_IMG_UINT8>(yImgOut, yImgIn, CENTER);
    ...
    else if (func_name == tr("iTiling"))
    {
        ...
        {
            //print Help info
            printf("\nUsage: ./visiocyte -x ireg -f iTiling -i <input_image> -o <output_image>\n");
            return true;
        }
        ...
        // Image Tiling
        VISIOCYTELONG sx = szImg_input[0];
        VISIOCYTELONG sy = szImg_input[1];
        VISIOCYTELONG sz = szImg_input[2];
        VISIOCYTELONG sc = szImg_input[3];


        // length = 0 ---- 40%
        // 1: [begin, length]; 2: [30%, 30%+length]; 3: [end-length,end]

        VISIOCYTELONG blckdimx = sx*0.75;
        VISIOCYTELONG blckdimy = sy*0.75;
        VISIOCYTELONG blckdimz = sz*0.4;
        VISIOCYTELONG blckdimc = sc;

        VISIOCYTELONG szblck = blckdimx * blckdimy * blckdimz * blckdimc;

        VISIOCYTELONG bx[2]={0, sx-blckdimx};
        VISIOCYTELONG by[2]={0, sy-blckdimy};
        VISIOCYTELONG bz[3]={0, sz*0.3, sz-blckdimz};

        VISIOCYTELONG sz_tile[4]={blckdimx, blckdimy, blckdimz, blckdimc};

        //
        VISIOCYTELONG xn=2, yn=2, zn=3;

        QString qs_filename_img_output = qs_output_img;
        if(datatype_input==VISIOCYTE_UINT8)
        {
            unsigned char *pTile = NULL;
            y_new<unsigned char, VISIOCYTELONG>(pTile, szblck);
            ...
            foreach(zn,k)
            {
                foreach(yn,j)
                {
                    foreach(xn,i)
                    {
                        VISIOCYTELONG cnt = k*yn*xn + j*xn + i;

                        QString qs_pathname_output=QFileInfo(qs_output_img).path();
                        QString qs_basename_output=QFileInfo(qs_output_img).baseName();

                        qs_filename_img_output=qs_pathname_output+"/"+qs_basename_output+QString("_tile%1.visiocyteraw").arg(cnt);

                        VISIOCYTELONG offsets = bz[k]*sy*sx + by[j]*sx + bx[i];
        ...
        else if(datatype_input==VISIOCYTE_UINT16)
        {
            unsigned short *pTile = NULL;
            unsigned short *pInput = (unsigned short *)pImg1d_input;
            y_new<unsigned short, VISIOCYTELONG>(pTile, szblck);
        ...
        else if(datatype_input==VISIOCYTE_FLOAT32)
        {
            cout << "Image data type is not supported!"<<endl;
            return false;
        }
    ...
    else if (func_name == tr("ierode"))
    {
        ...
        {
            //print Help info
            printf("\nUsage: ./visiocyte -x ireg -f ierode -i <input_image> -o <output_image>\n");
            return true;
        }
        ...
        VISIOCYTELONG sz = szImg_input[2];
        VISIOCYTELONG sc = szImg_input[3];
        VISIOCYTELONG offset_y = sx;
        VISIOCYTELONG offset_z = sx*sy;

        unsigned char *pImg1d_output=NULL;

        VISIOCYTELONG totalpxls = sx*sy*sz*sc*datatype_input;
        y_new<unsigned char, VISIOCYTELONG>(pImg1d_output,totalpxls);

        for(VISIOCYTELONG i=0; i<totalpxls; i++)
            pImg1d_output[i] = pImg1d_input[i];

        for(VISIOCYTELONG iter=0; iter<1; iter++)
        {
            VISIOCYTELONG neighbors[6] = {-1, 1, -offset_y, offset_y, -offset_z, offset_z};
    ...
    else if (func_name == tr("inormalize"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f inormalize -o <output> -p \" #s <sub> #t <tar>\" \n");
            return true;
        }
        ...
        if(paras)
        {
            ...
            if(outfile)
            {
                ...
                qs_filename_normalized=qs_pathname_output+"/"+qs_basename_output+".visiocyteraw";
            }
            else
            {
                qs_filename_normalized=qs_pathname_input+"/"+qs_basename_input+".visiocyteraw";
            }
        ...
        VISIOCYTELONG pagesz = sz_sub[0]*sz_sub[1]*sz_sub[2];
        unsigned char * pOut = NULL;
        y_new<unsigned char, VISIOCYTELONG>(pOut, pagesz);
    ...
    else if (func_name == tr("createMaskImage"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f createMaskImage -i <input> -o <output> \n");
            return true;
        }
        ...
        {
            qs_filename_output=qs_pathname_input+"/"+qs_basename_input+"Mask.visiocyteraw";
        }
    ...
    else if (func_name == tr("resamplebyspacing"))
    {
        ...
        if(input.size()<1) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f resamplebyspacing -i <input> -o <output> -p \"#x <sample_ratio_x> #y <sample_ratio_y> #z <sample_ratio_z>\"!\n");
            return true;
        }
        ...
        VISIOCYTELONG pagesz_input = sx*sy*sz;
        VISIOCYTELONG pagesz = ssx*ssy*ssz;

        y_new<unsigned char, VISIOCYTELONG>(pResample, pagesz*sc);


        //
        REAL *pInput = NULL;
        VISIOCYTELONG totalplxs = pagesz_input*sc;
        y_new<REAL, VISIOCYTELONG>(pInput, totalplxs);
        ...
        else if(datatype == CHAR)
        {
            ...
            rescaling<REAL, VISIOCYTELONG>(pInput, totalplxs, lv, rv);
        }
        ...
        foreach(sc, c)
        {
            ...
            resize<VISIOCYTELONG, Y_IMG_REAL, Y_IMG_UINT8>(pOut, pIn, SAMPLE);
        }
    ...
    else if (func_name == tr("gaussianfilter"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f gaussianfilter -i <input> -o <output> -p \"#x <radius_x> #y <radius_y> #z <radius_z>\"  \n");
            return true;
        }
        ...
        REAL *p = NULL;
        y_new<REAL, VISIOCYTELONG>(p, pagesz);
        ...
        foreach(sc, c)
        {
            ...
            if(szData==1)
            {
                ...
                guassianFiltering<REAL, VISIOCYTELONG>(p, szOut, w);
                rescaling<REAL, VISIOCYTELONG>(p,pagesz,0,255);
            ...
            else if(szData==2)
            {
                ...
                guassianFiltering<REAL, VISIOCYTELONG>(p, szOut, w);
                rescaling<REAL, VISIOCYTELONG>(p,pagesz,0,4096);
    ...
    else if (func_name == tr("cropImage"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f cropImage -i <input> -o <output> -p \"#m <mask> #x <samplingratio_x> #y <samplingratio_y> #z <samplingratio_z>\" \n");
            return true;
        }
        ...
        {
            qs_filename_output=qs_pathname_input+"/"+qs_basename_input+"_cropped.visiocyteraw";
        ...
        // original image size
        VISIOCYTELONG osx, osy, osz;
        osx = sz_img1[0];
        osy = sz_img1[1];
        osz = sz_img1[2];

        // mask
        VISIOCYTELONG adjpixels=4;

        VISIOCYTELONG minx, miny, minz;
        VISIOCYTELONG maxx, maxy, maxz;
        ...
        else
        {
            ...
            if(QFileInfo(qs_filename_mask).suffix().toUpper().compare("LSM") == 0)
            {
                ...
                {
                    printf("ERROR: loadImage() fails.\n");
                    y_del2<unsigned char, VISIOCYTELONG>(p1dMask, sz_mask);
                    return false;
                }
            }
            else
            ...
            foreach(sz_mask[2],k)
            {
                VISIOCYTELONG offset_k = k*sz_mask[0]*sz_mask[1];
                foreach(sz_mask[1],j)
                {
                    VISIOCYTELONG offset_j = offset_k + j*sz_mask[0];
                    foreach(sz_mask[0],i)
                    {
        ...
        //
        VISIOCYTELONG pagesz = sx*sy*sz;
        VISIOCYTELONG totalpxls = pagesz*sc;
        unsigned char * pOut = NULL;
        y_new<unsigned char, VISIOCYTELONG>(pOut, totalpxls*datatype_img1);

        //
        foreach(sc, c)
        {
            VISIOCYTELONG offset_c = c*pagesz;
            VISIOCYTELONG offset_c_input = c*sz_img1[0]*sz_img1[1]*sz_img1[2];
            foreach(sz, k)
            {
                VISIOCYTELONG offset_k = offset_c + k*sx*sy;
                VISIOCYTELONG offset_k_input = offset_c_input + (k+minz)*sz_img1[0]*sz_img1[1];
                foreach(sy, j)
                {
                    VISIOCYTELONG offset_j = offset_k + j*sx;
                    VISIOCYTELONG offset_j_input = offset_k_input + (j+miny)*sz_img1[0];
                    foreach(sx, i)
                    {
                        if(datatype_img1==UINT8)
                        {
    ...
    else if (func_name == tr("convertTC2AM"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f convertTC2AM -i <.tc> -o <.txt> -p \"#x <ratio_x> #y <ratio_y> #z <ratio-z> \" \n");
            return true;
        }
    ...
    else if (func_name == tr("zeropadding"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f zeropadding -i <input> -o <output> -p \"#c <configure.txt> #x <samplingratio_x> #y <samplingratio_y> #z <samplingratio_z>\" \n");
            return true;
        }
        ...
        {
            qs_filename_output=qs_pathname_input+"/"+qs_basename_input+"_padding.visiocyteraw";
        }
        ...
        if(datatype_img1==VISIOCYTE_UINT8)
        {
            //
            foreach(sc, c)
            {
                ...
                foreach(csz, k)
                {
                    VISIOCYTELONG offset_k = offset_c + (k+minz)*sx*sy;
                    VISIOCYTELONG offset_k_input = offset_c_input + k*csx*csy;
                    foreach(csy, j)
                    {
                        VISIOCYTELONG offset_j = offset_k + (j+miny)*sx;
                        VISIOCYTELONG offset_j_input = offset_k_input + j*csx;
                        foreach(csx, i)
                        {
        ...
        else if(datatype_img1==VISIOCYTE_UINT16)
        {
        ...
        else if(datatype_img1==VISIOCYTE_FLOAT32)
        {
    ...
    else if (func_name == tr("rigidreg"))
    {
        ...
        //
        y_new<unsigned char, VISIOCYTELONG>(pSubDS, pagesz);
        y_new<unsigned char, VISIOCYTELONG>(pTarDS, pagesz);
        ...
        // rigid registration
        Y_MAT<REAL, VISIOCYTELONG> M; // 3D A4x4
        M.init(4,4,0);
        ...
        rigidregbf<unsigned char, VISIOCYTELONG, Y_MAT<REAL, VISIOCYTELONG> >(M, pSubDS, pTarDS, szResample[0], szResample[1], szResample[2], theta, thetastep, translate, translatestep);
    ...
    else if (func_name == tr("rotEstimate"))
    {
        ...
        {
            //print Help info
            cout<<"./visiocyte -x ireg -f rotEstimate ..."<<endl;
            return true;
        }
        ...
        //
        rotregbf<unsigned char, VISIOCYTELONG, Y_MAT<REAL, VISIOCYTELONG> >(M, pSubDS, pTarDS, szResample[0], szResample[1], szResample[2], 15, 15, 180, 5, 1, 1);
    ...
    else if (func_name == tr("convertSigned16bit2Unsigned16bit"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f convertSigned16bit2unsigned16bit -i <input> -o <output>\n");
            return true;
        }
        ...
        if(QFileInfo(qs_filename_input).suffix().toUpper().compare("LSM") == 0)
        {
            ...
            {
                printf("ERROR: loadImage() fails.\n");
                y_del2<unsigned char, VISIOCYTELONG>(p1d_img1, sz_img1);
                return false;
            }
        }
        else
        ...
        VISIOCYTELONG sc = sz_img1[3];
        VISIOCYTELONG totalplxs_sub = sz_img1[0]*sz_img1[1]*sz_img1[2]*sc;

        int datatype_out = 2;

        p_input = (short *)p1d_img1;
        y_new<unsigned short, VISIOCYTELONG>(p_out, totalplxs_sub);

        short max_v, min_v;
        imaxmin<short, VISIOCYTELONG>(p_input, totalplxs_sub, max_v, min_v);
    ...
    else if (func_name == tr("icut"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f icut -i <input> -o <output> -p \"#t <threshold> #f <front_z> #b <back_z> #u <up_y> #d <down_y> #l <left_x> #r <right_x>\"\n");
            return true;
        }
        ...
        REAL thresholdcut = 0;
        VISIOCYTELONG left_x=0, right_x=0;
        VISIOCYTELONG up_y=0, down_y=0;
        VISIOCYTELONG front_z=0, back_z=0;
        ...
        //
        VISIOCYTELONG *szOut=NULL;
        y_new<VISIOCYTELONG, VISIOCYTELONG>(szOut,4);
        unsigned char *pOut = NULL;

        if(datatype_img1==UINT8)
        {
            imgcutting<unsigned char, VISIOCYTELONG>(pOut, szOut, p1d_img1, sz_img1, thresholdcut, left_x, right_x, up_y, down_y, front_z, back_z);
        }
        else if(datatype_img1==UINT16)
        {
            unsigned short *p_input = (unsigned short *)p1d_img1;
            unsigned short *p = (unsigned short *)pOut;
            imgcutting<unsigned short, VISIOCYTELONG>(p, szOut, p_input, sz_img1, thresholdcut, left_x, right_x, up_y, down_y, front_z, back_z);
    ...
    else if (func_name == tr("meandeviation"))
    {
        ...
        if(input.size()<1 ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f meandeviation -i <input> \n");
            return true;
        }
    ...
    else if (func_name == tr("esimilarity"))
    {
        ...
        {
            //print Help info
            cout<<"visiocyte -x ireg -f esimilarity -o <score.txt> -p \"#s <aligned.tif> #cs <aligned_refchn> #t <template.tif> #ct <template_refchn> #m <mask.tif>\""<<endl;
            return true;
        }
        ...
        if(qs_filename_mask!=NULL && QFile(qs_filename_mask).exists())
        {
            if(!loadImage((char *)qPrintable(qs_filename_mask),p_img_mask,sz_mask,datatype_mask))
            {
                ...
                y_del2<unsigned char, VISIOCYTELONG>(p_img_mask, sz_mask);
                return false;
            }
        }
        ...
        // reference channels
        VISIOCYTELONG pagesz = sz_img_sub_input[0]*sz_img_sub_input[1]*sz_img_sub_input[2];
        VISIOCYTELONG offsets_sub = channel_ref_sub*pagesz;
        VISIOCYTELONG offsets_tar = channel_ref_tar*pagesz;
        ...
        if(qs_filename_mask!=NULL && QFile(qs_filename_mask).exists())
        {
            qa_ncc = nccwmask<unsigned char, VISIOCYTELONG>(p_sub, p_tar, p_img_mask, pagesz);
        }
        else
        {
            qa_ncc = ncc<unsigned char, VISIOCYTELONG>(p_sub, p_tar, pagesz);
        }
    ...
    else if (func_name == tr("evalAlignQuality"))
    {
        ...
        // evaluating
        double qa_nmi = nmi<unsigned char, VISIOCYTELONG>(p_sub, p_tar, pagesz);
        double qa_ncc = ncc<unsigned char, VISIOCYTELONG>(p_sub, p_tar, pagesz);
    ...
    else if (func_name == tr("extractRotMat"))
    {
        ...
        {
            //print Help info
            printf("\nUsage: visiocyte -x ireg -f extractRotMat -i <input_rigid_transformation> -o <output_rotation_transformation>\n");
            return true;
        }
        ...
        if(qs_filename_affinematrix!=NULL && QFile(qs_filename_affinematrix).exists())
        {
            ...
            Y_AFFINETRANSFORM<REAL, VISIOCYTELONG> rotations;
            rotations.setTransform(afftrans.pTransform, 3);

            rotations.keepRotations();

            Y_MAT<REAL,VISIOCYTELONG> mat(rotations.pTransform,4,4);
            mat.transpose();
    ...
    else if (func_name == tr("recoverRef"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f recoverRef -i <input> -o <output> -p \"#r <ref_channel>\"\n");
            return false;
        }
        ...
        {
            qs_filename_output=qs_pathname_input+"/"+qs_basename_input+"recovered.visiocyteraw";
        }
        ...
        //
        VISIOCYTELONG pagesz = sz_img1[0]*sz_img1[1]*sz_img1[2];
        VISIOCYTELONG totalsz = pagesz*sz_img1[3];

        REAL a,b;
        VISIOCYTELONG idx;
        unsigned char *pOut = NULL;

        VISIOCYTELONG offs = (sz_img1[3]-1-refn)*pagesz;
        VISIOCYTELONG offr = refn*pagesz;
        ...
        if(datatype_img1==1)
        {
            ...
            getMaximum<unsigned char, VISIOCYTELONG>(pX, pagesz, x1, idx);
            y1 = pY[idx];

            getMaximum<unsigned char, VISIOCYTELONG>(pY, pagesz, y2, idx);
            x2 = pX[idx];

            a = (REAL)x1/((REAL)x1+(REAL)y1);
            b = (REAL)y2/((REAL)x2+(REAL)y2);

            y_new<unsigned char, VISIOCYTELONG>(pOut, totalsz);
        ...
        else if(datatype_img1==2)
        {
            ...
            getMaximum<unsigned short, VISIOCYTELONG>(pX, pagesz, x1, idx);
            y1 = pY[idx];

            getMaximum<unsigned short, VISIOCYTELONG>(pY, pagesz, y2, idx);
            x2 = pX[idx];

            a = (REAL)x1/((REAL)x1+(REAL)y1);
            b = (REAL)y2/((REAL)x2+(REAL)y2);

            y_new<unsigned char, VISIOCYTELONG>(pOut, totalsz*sizeof(unsigned short));
    ...
    else if (func_name == tr("rescaleInt"))
    {
        ...
        if(paras)
        {
            ...
            if(qs_filename_img_tar==NULL || qs_filename_img_sub==NULL)
            {
                ...
                //print Help info
                cout<<"visiocyte -x ireg -f rescaleInt -o <output> -p \"#s <original_image> #t <aligned_image>\""<<endl;
                return false;
            }
        ...
        //
        VISIOCYTELONG sc=sz_img_sub_input[3];
        VISIOCYTELONG pagesz_sub = sz_img_sub_input[0]*sz_img_sub_input[1]*sz_img_sub_input[2];

        VISIOCYTELONG tc=sz_img_tar_input[3];
        VISIOCYTELONG pagesz_tar = sz_img_tar_input[0]*sz_img_tar_input[1]*sz_img_tar_input[2];
        VISIOCYTELONG totalsz = pagesz_tar*tc;
        ...
        y_new<unsigned char, VISIOCYTELONG>(pOut, totalsz*datatype_tar_input);
    ...
    else if (func_name == tr("convertDatatype"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f convertDatatype -i <input> -o <output> -p \"#t <target> #k <keepinputscale>\"!\n");
            return true;
        }
        ...
        if(datatype_img1==UINT8)
        {
            ...
            else if(targetdatatype==2)
            {
                ...
                {
                    foreach(totalplxs_sub, i)   p[i] = p1dImg1[i];
                    rescaling<unsigned short, VISIOCYTELONG>(p, totalplxs_sub, 0, 4095);
                }
            }
    ...
    else if (func_name == tr("ppleftopticlobe"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f ppleftopticlobe -i <input> -o <output> \n");
            return true;
        }
        ...
        //
        VISIOCYTELONG slicesz = sz_img[0]*sz_img[1];
        VISIOCYTELONG channelsz = slicesz*sz_img[2];
        VISIOCYTELONG totalplxs = channelsz*sz_img[3];
        VISIOCYTELONG i,j,k;

        /// rotate 90 degree clockwise
        unsigned char *pOut = NULL;
        y_new<unsigned char, VISIOCYTELONG>(pOut, totalplxs*datatype_img);
        ...
        foreach(sz_img[3], c)
        {
            if(datatype_img == 1)
            {
                ...
                {
                    VISIOCYTELONG offk = k*slicesz;
                    for (j=0;j<sz_img[1];j++)
                    {
                        VISIOCYTELONG offj = offk + j*sz_img[0];
    ...
    else if (func_name == tr("computeRef"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f computeRef -i <folder> -o <output> -p \"#r <ref_channel>\"\n");
            return false;
        }
        ...
        {
            qs_filename_output=qs_pathname_input+"/"+qs_basename_input+"ref.visiocyteraw";
        }
        ...
        float *p=NULL;
        VISIOCYTELONG sx,sy,sz,sc, imgsz;

        VISIOCYTELONG N=imgList.size();
        ...
        for(int i=0; i<N; i++)
        {
            ...
            if(i==0)
            {
                ...
                y_new<float, VISIOCYTELONG>(p, imgsz);
...
//                }
    ...
    else if (func_name == tr("celltracker"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f celltracker -i <folder> -o <output> -p \"#r <ref_channel> #m <marker_file> #t <thresh> #v <var>\"\n");
            return false;
        }
        ...
        for(int i=0; i<N; i++)
        {
            ...
            if(i==0)
            {
                ...
                y_new<unsigned short, VISIOCYTELONG>(p, imgsz);
            ...
            if(datatype_img1==1)
            {
                ...
                {
                    regiongrow<unsigned char, unsigned short, VISIOCYTELONG>(pIn, p, sx, sy, sz, seeds[j].x, seeds[j].y, seeds[j].z, j+1, thresh, var);
            ...
            else if(datatype_img1==2)
            {
                ...
                for(int j=0; j<seeds.size(); j++)
                {
                    regiongrow<unsigned short, unsigned short, VISIOCYTELONG>(pIn, p, sx, sy, sz, seeds[j].x, seeds[j].y, seeds[j].z, j+1, thresh, var);
                }
            }
    ...
    else if (func_name == tr("mipSequence"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f mipSequence -i <folder> -o <output> -p \"#r <ref_channel>\"\n");
            return false;
        }
        ...
        VISIOCYTELONG dimx, dimy, dimz;

        // image
        QStringList imgList = importSeriesFileList_addnumbersort(qs_filename_input);

        VISIOCYTELONG n=imgList.size(), imgsz;
        ...
        for(VISIOCYTELONG i=0; i<n; i++)
        {
            ...
            if(i==0)
            {
                ...
                y_new<unsigned char, VISIOCYTELONG>(p, imgsz*datatype_img1);
            ...
            else if(datatype_img1==2)
            {
                ...
                for(VISIOCYTELONG j=0; j<imgsz; j++)
                {
    ...
    else if (func_name == tr("cellprofiler"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f cellprofiler -i <folder> -o <output> -p \"#r <ref_channel> #m <marker_file>\"\n");
            return false;
        }
        ...
        //
        float *p=NULL;
        VISIOCYTELONG sx=0, sy=0; // sy = labels, sx = time
...
//            return true;
        ...
        y_new<float, VISIOCYTELONG>(p, sx*sy);
        ...
        for(int i=0; i<sx; i++)
        {
            ...
            else if(datatype_img1==2)
            {
                ...
                else if(datatype_mask==2)
                {
                    ...
                    for(int j=0; j<sy; j++)
                    {
                        for(VISIOCYTELONG z=0; z<dimz; z++)
                            for(VISIOCYTELONG y=0; y<dimy; y++)
                                for(VISIOCYTELONG x=0; x<dimx; x++)
                                {
                                    VISIOCYTELONG idx = z*dimx*dimy + y*dimx + x;
    ...
    else if (func_name == tr("marker2volume"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f marker2volume -i <marker> -o <image> -p \"#r <radius> #i <intensity_value> #x <dimx> #y <dimy> #z <dimz> \"\n");
            return false;
        }
        ...
        y_new<unsigned char, VISIOCYTELONG>(p, sx*sy*sz);
        memset(p, 0, sx*sy*sz);
    ...
    else if (func_name == tr("valueReplace"))
    {
        ...
        {
            printf("ERROR: loadImage() fails.\n");
            y_del2<unsigned char, VISIOCYTELONG>(p1dImg, szimg);
            return false;
        }
    ...
    else if (func_name == tr("absOrient"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            cout<<"Invalid inputs!"<<endl;
            cout<<"./visiocyte -x ireg -f absoluteOrientation -o <rotation_matrix> -p \"#s <sub> #t <tar>\" "<<endl;
            return true;
        }
        ...
        ///////
        //
        for(VISIOCYTELONG i=0; i<R.column; i++)
        {
            for(VISIOCYTELONG j=0; j<R.row; j++)
            {
                cout<<" "<<R.v[i][j];
            }
            cout<<endl;
    ...
    else if (func_name == tr("extractVOI"))
    {
        ...
        {
            //print Help info
            printf("/nUsage: visiocyte -x ireg -f extractVOI -i <input> -o <output> -p \"#m <mask> #x <samplingratio_x> #y <samplingratio_y> #z <samplingratio_z>\" \n");
            return true;
        }
        ...
        foreach(sc, c)
        {
            ...
            {
                VISIOCYTELONG offset_k = offset_c + k*sx*sy;
                VISIOCYTELONG offk = k*sx*sy;
                foreach(sy, j)
                {
                    VISIOCYTELONG offset_j = offset_k + j*sx;
                    VISIOCYTELONG offj = offk + j*sx;
                    foreach(sx, i)
                    {
                        if(datatype_img1==UINT8)
                        {
    ...
    else if (func_name == tr("genVOIs"))
    {
        ...
        if(input.size()<1 || (input.size()==1 && output.size()<1) ) // no inputs
        {
            //print Help info
            printf("\nError occurred!\n");
            printf("\nUsage: visiocyte -x ireg -f genVOIs -p \"#s <subject> #t <target>\"!\n");
            return true;
        }
        ...
        if(paras)
        {
            ...
            if(!outfile)
            {
                ...
                qs_filename_output_sub=qs_pathname_input+"/"+qs_basename_input+"_rs.visiocyteraw";

                qs_basename_input=QFileInfo(qs_filename_img_tar).baseName();
                qs_pathname_input=QFileInfo(qs_filename_img_tar).path();

                qs_filename_output_tar=qs_pathname_input+"/"+qs_basename_input+"_rs.visiocyteraw";
            }
        ...
        if(datatype_img1==UINT8 && datatype_img2==UINT8) // 8-bit
        {
            ...
            szimg[0] = y_max<VISIOCYTELONG>(pTar.bex - pTar.bbx, pSub.bex - pSub.bbx) + extraVoxels;
            szimg[1] = y_max<VISIOCYTELONG>(pTar.bey - pTar.bby, pSub.bey - pSub.bby) + extraVoxels;
            szimg[2] = y_max<VISIOCYTELONG>(pTar.bez - pTar.bbz, pSub.bez - pSub.bbz) + extraVoxels;
            szimg[3] = 1;

            VISIOCYTELONG totalplxs = szimg[0]*szimg[1]*szimg[2];


            // tar
            unsigned char *p_tar = NULL;
            y_new<unsigned char, VISIOCYTELONG>(p_tar, totalplxs);

            Y_IMG_UINT8 pTarRs;
            pTarRs.setImage(p_tar, szimg, 4);

            resizeImage<unsigned char, VISIOCYTELONG, Y_IMG_UINT8>(pTarRs, pTar, 0, true);
            ...
            // sub
            szimg[3] = y_max<VISIOCYTELONG>(sz_img1[3], sz_img2[3]);
            totalplxs *= szimg[3];
            ...
            resizeImage<unsigned char, VISIOCYTELONG, Y_IMG_UINT8>(pSubRs, pSub, 0, true);
