...
struct PARA_APP2: public PARA_VN
{
    ...
    bool app2_dialog()
    {
        ...
        // fetch parameters from dialog
        {
            ...
            dialog->setWindowTitle("Visiocyte-Neuron2 Auto_tracing Based on APP2 (All-Path-Pruning-v2)");
    ...
    bool fetch_para_commandline(const VISIOCYTEPluginArgList &input, VISIOCYTEPluginArgList &output, VISIOCYTEPluginCallback2 &callback, QWidget *parent);
};
