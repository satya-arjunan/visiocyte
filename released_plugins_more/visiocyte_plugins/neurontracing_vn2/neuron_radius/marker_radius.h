...
//========================== 3D ==========================
template<class T> double markerRadius(T* &inimg1d, VISIOCYTELONG * sz, MyMarker & marker, double thresh, int method = DEFAULT_MARKER_RADIUS_METHOD)
{
...
template<class T> double markerRadius_accurate(T* &inimg1d, VISIOCYTELONG * sz, MyMarker & marker, double thresh)
{
...
template<class T> double markerRadius_fast(T* &inimg1d, VISIOCYTELONG * sz, MyMarker & marker, double thresh)
{
...
template<class T> double markerRadius_hanchuan_XY(T* &inimg1d, VISIOCYTELONG * sz, MyMarker & marker, double thresh)
{
...
template<class T> double markerRadius_hanchuan(T* &inimg1d, VISIOCYTELONG * sz, MyMarker & marker, double thresh)
{
...
//========================== 2D ==========================
template<class T> double markerRadiusXY(T* &inimg1d, VISIOCYTELONG * sz, MyMarker & marker, double thresh)
{
