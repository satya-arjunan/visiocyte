...
void printHelp()
{
	...
	cout<<"Usage: visiocyte -x hier_label -f hierachical_labeling -i <input_neuron> -o <output_eswc>"<<endl;
	...
	cout<<"Example: visiocyte-x hier_label -f hierachical_labeling -i input.swc -o input_labeled.swc\n"<<endl;
}
