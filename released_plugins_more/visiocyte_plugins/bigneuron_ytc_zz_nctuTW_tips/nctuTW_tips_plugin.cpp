...
void nctuTW_tips::domenu(const QString &menu_name, VISIOCYTEPluginCallback2 &callback, QWidget *parent)
{
...
bool nctuTW_tips::dofunc(const QString & func_name, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, VISIOCYTEPluginCallback2 & callback,  QWidget * parent)
{
    ...
    else if (func_name == tr("help"))
    {
		...
		printf("visiocyte -x nctuTW_tips -f tracing_func -i <inimg_file> -p <channel> <other parameters>\n");
...
void reconstruction_func(VISIOCYTEPluginCallback2 &callback, QWidget *parent, input_PARA &PARA, bool bmenu)
{
    ...
    LocationSimple tmpp;
    for(VISIOCYTELONG i = 1; i <file_inmarkers.size(); i++)
    {
