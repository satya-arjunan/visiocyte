...
import java.io.*;
import java.util.*;
//2014.01.16 brl modifying to write .visiocyteraw from virtual stack without having to read whole file into memory
...
public class raw_writerBRL implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		SaveDialog sd = new SaveDialog("Save VISIOCYTE's Raw Image...",imp.getTitle(),".visiocyteraw");
...
// FileOutputStream out = new FileOutputStream(directory+fileName);
			...
			case ImagePlus.COLOR_RGB:
				unitSize = 1;     // BRL corrected this case to be compatible with 32-bit RGB images like the visiocyte example file ex_Repo_hb9_eve.tiff
