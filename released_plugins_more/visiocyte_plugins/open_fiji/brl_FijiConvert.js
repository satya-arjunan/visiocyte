...
if ((inextension==".visiocyteraw") || (inextension==".raw"))
{
print("reading .visiocyteraw or .raw file with raw reader");
...
print("no output file extension, appending '.visiocyteraw' and saving")
}
else 
{
...
else if (outextension==".visiocyteraw") 
{
//raw_writer
...
{
outname=outname.concat(".visiocyteraw");
