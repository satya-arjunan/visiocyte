...
public:
    ...
    void auto_detect_seedz(LandmarkList &seedList,VISIOCYTELONG slice,const int InitThreshold,const int seed_size_all);
    void auto_detect_seedx(LandmarkList &seedList,VISIOCYTELONG slice,const int InitThreshold,const int seed_size_all);
    void auto_detect_seedy(LandmarkList &seedList,VISIOCYTELONG slice,const int InitThreshold,const int seed_size_all);
