...
class ImageBlendPlugin : public QObject, public VISIOCYTEPluginInterface2_1
{
    Q_OBJECT
...
public:
    ImageBlendingDialog(VISIOCYTEPluginCallback2 &callback, QWidget *parentWidget, QString filename)
	{
