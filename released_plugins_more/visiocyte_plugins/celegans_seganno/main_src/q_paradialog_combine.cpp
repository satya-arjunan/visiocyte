...
ParaDialogCombine::ParaDialogCombine(VISIOCYTEPluginCallback &callback,QWidget *parent):QDialog(parent)
{
	setupUi(this);
	IniDialog(callback);
}

void ParaDialogCombine::IniDialog(VISIOCYTEPluginCallback &callback)
{
	//read settings
	QSettings settings("VISIOCYTE plugin","atlasguided_seganno");
