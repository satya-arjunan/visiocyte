...
void AtlasGuidedSegAnno(VISIOCYTEPluginCallback &callback, QWidget *parent);
...
void AtlasGuidedSegAnnoPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback &callback, QWidget *parent)
{
...
void AtlasGuidedSegAnno(VISIOCYTEPluginCallback &callback, QWidget *parent)
{
	...
	if(paraDlg.exec()==QDialog::Accepted)
	{
		...
		//visualization
		paras.b_showinVISIOCYTE_img=paraDlg.checkBox_showVISIOCYTE_img->isChecked();
...
//		CParas paras;
//		bool b_imgfromvisiocyte=0;
//		QString qs_filename_img;
//		for(long i=0;i<9;i++)
//		{
//		if(i==0){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/cnd1threeL1_1213061_crop_straight.raw";
//		paras.b_atlasupsidedown=0;}
//		else if(i==1){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/cnd1threeL1_1228061_crop_straight.raw";
//		paras.b_atlasupsidedown=0;}
//		else if(i==2){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/cnd1threeL1_1229061_crop_straight.raw";
//		paras.b_atlasupsidedown=0;}
//		else if(i==3){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/cnd1threeL1_1229062_crop_straight.raw";
//		paras.b_atlasupsidedown=1;}
//		else if(i==4){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/cnd1threeL1_1229063_crop_straight.raw";
//		paras.b_atlasupsidedown=1;}
//		else if(i==5){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/jkk1SD1439L1_0904072_crop_straight.raw";
//		paras.b_atlasupsidedown=1;}
//		else if(i==6){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/jkk1SD1439L1_0904073_crop_straight.raw";
//		paras.b_atlasupsidedown=1;}
//		else if(i==7){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/jkk1SD1439L1_0904074_crop_straight.raw";
//		paras.b_atlasupsidedown=0;}
//		else if(i==8){
//		qs_filename_img="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/jkk1SD1439L1_0904075_crop_straight.raw";
//		paras.b_atlasupsidedown=0;}
//
//		QString qs_filename_atals_input="/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/data/atlas.apo";
...
//		paras.d_annealingrate=0.95;
		...
		printf(">>b_imgfromvisiocyte:             %d\n",paras.b_imgfromVISIOCYTE);
		...
		printf(">>b_showinVISIOCYTE_img:          %d\n",paras.b_showinVISIOCYTE_img);
		printf(">>b_showinVISIOCYTE_pts:          %d\n",paras.b_showinVISIOCYTE_pts);
		...
		{
			printf("1. Import image from VISIOCYTE. \n");
			long l_imgind=paraDlg.comboBox_imgvisiocyte->currentIndex();
			if(l_imgind<0)
			{
...
//		qs_filename_atals_output=QString("/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/%1.apo").arg(i);
//		writeAPO_file(qPrintable(qs_filename_atals_output),ql_musclecell_output);
