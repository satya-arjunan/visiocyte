...
% %%
% %read atlas apo file
% filename_apo_atlas='/Users/qul/work/visiocyte_2.0/sub_projects/celegant_atlas_builder/atlas.apo';
...
% %     save_visiocyte_raw_img_file(uint8(mask),['mask_vor',num2str(file_ind),'.raw']);
% end
% clear ind
...
% mask(ind_ini)=255;
% save_visiocyte_raw_img_file(uint8(mask),['mask_ini',num2str(file_ind),'.raw']);
% 
...
% save_visiocyte_raw_img_file(uint8(I_g),'I_smooth.raw');
% 
...
% % save_visiocyte_raw_img_file(uint8(I_g),'tmp.raw');