...
filename_apo_atlas='/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/result_downsample4/affine_6.apo';
...
%     save_visiocyte_raw_img_file(uint8(tmp),'mask.raw');
end
clear ind
...
for iter=1:100
    ...
    save_visiocyte_raw_img_file(uint8(I_g_s),'img_2.raw');
