...
ratio=4;
foldername_output='/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/result_fullresolution/';

%read atlas apo file
for i=1:9
    i
    filename_apo=['noaffine',num2str(i),'.apo'];
    apo_atlas=load_visiocyte_apo_file(filename_apo);
...
%     filename_apo_output=['/Users/qul/work/visiocyte_2.0/sub_projects/atlasguided_seganno/result_fullresolution/noaffine',num2str(i),'.apo'];
    switch i
    case 1  
    ...
    save_visiocyte_apo_file(apo_atlas,filename_apo_output);
end
