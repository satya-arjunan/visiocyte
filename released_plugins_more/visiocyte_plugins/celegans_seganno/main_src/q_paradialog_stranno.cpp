...
CParaDialog_stranno::CParaDialog_stranno(VISIOCYTEPluginCallback &callback,QWidget *parent):QDialog(parent)
{
	setupUi(this);
	IniDialog(callback);
}
...
void CParaDialog_stranno::IniDialog(VISIOCYTEPluginCallback &callback)
{
	//read settings
	QSettings settings("VISIOCYTE plugin","atlasguided_stranno");
	//file io
