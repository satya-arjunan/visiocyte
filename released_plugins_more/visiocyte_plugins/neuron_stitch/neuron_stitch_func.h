...
typedef QVector<QVector<VISIOCYTELONG> > HBNeuronGraph;
...
VISIOCYTELONG nextPointNeuronGraph(const HBNeuronGraph& ng, VISIOCYTELONG current, VISIOCYTELONG previous=-1);
