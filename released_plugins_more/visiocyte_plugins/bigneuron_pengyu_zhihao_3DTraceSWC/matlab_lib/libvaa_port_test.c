 ...
 * Date: Tue Nov 17 15:17:22 2015
 * Arguments: "-B" "macro_default" "-B" "csharedlib:libvaa_port_test" "-W"
 * "lib:libvaa_port_test" "-T" "link:lib" "visiocyte_trace3D" 
 */
...
LIB_libvaa_port_test_C_API 
bool MW_CALL_CONV mlxVisiocyte_trace3D(int nlhs, mxArray *plhs[], int nrhs, mxArray *prhs[])
{
  return mclFeval(_mcr_inst, "visiocyte_trace3D", nlhs, plhs, nrhs, prhs);
}

LIB_libvaa_port_test_C_API 
bool MW_CALL_CONV mlfVisiocyte_trace3D(int nargout, mxArray** result, mxArray* raw, mxArray* 
                                   unit_bytes, mxArray* x, mxArray* y, mxArray* z, 
                                   mxArray* t, mxArray* para, mxArray* fileDir)
{
  return mclMlfFeval(_mcr_inst, "visiocyte_trace3D", nargout, 1, 8, result, raw, unit_bytes, x, y, z, t, para, fileDir);
}
