...
extern LIB_libvaa_port_test_C_API bool MW_CALL_CONV mlfVisiocyte_trace3D(int nargout, mxArray** result, mxArray* raw, mxArray* unit_bytes, mxArray* x, mxArray* y, mxArray* z, mxArray* t, mxArray* para, mxArray* fileDir);
