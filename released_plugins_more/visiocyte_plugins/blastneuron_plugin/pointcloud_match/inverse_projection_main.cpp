...
#include <io.h>
#endif
int inverse_projection_main(const VISIOCYTEPluginArgList &input, VISIOCYTEPluginArgList & output)
{
...
void printHelp_invp()
{
	...
	cout<<"Example: visiocyte -x  blastneuron -f inverse_projection -p \"#t target.swc #s subject.swc #o subject_invp.swc\"\n"<<endl;
}
