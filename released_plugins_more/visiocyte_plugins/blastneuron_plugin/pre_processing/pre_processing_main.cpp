...
{
    printf("\nVisiocyte plugin: Pre-processing step for BlastNeuron pipeline, including: \n");
    ...
    printf("Usage: visiocyte -x blastneuron -f pre_processing -p \"#i input.swc #o result.swc #l 3 #s 2 #t 2 #r 0\"\n");
}
