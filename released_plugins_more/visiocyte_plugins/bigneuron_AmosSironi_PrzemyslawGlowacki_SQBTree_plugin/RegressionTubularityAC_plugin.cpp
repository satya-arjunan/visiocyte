...
bool trainTubularityImage(VISIOCYTEPluginCallback2 &callback, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output);

bool resampleImage(VISIOCYTEPluginCallback2 &callback, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output);
...
void RegressionTubularityACPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback2 &callback, QWidget *parent)
{
  if (menu_name == tr("test"))
  {
    visiocyte_msg("To be implemented. Please call this plugin from command line.\n\n "
            "Example call: ./visiocyte -x RegressionTubularityAC -f test   \n "
            "-i <Test_Img1.tif> <Test_Img2.tif> ... <Test_ImgN.tif> \n"
            "-o  <Tubularity_img1.raw> <Tubularity_Img2.raw> ... <Tubularity_ImgN.visiocyteraw> \n"
  ...
  {
      visiocyte_msg("To be implemented. Please call this plugin from command line. \n\n"
              "Example call: ./visiocyte -x RegressionTubularityAC -f train \n"
  ...
  {
    visiocyte_msg(tr("A plugin for training and testing a tubularity regressor [1]. \n"
...
bool RegressionTubularityACPlugin::dofunc(const QString & func_name, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, VISIOCYTEPluginCallback2 & callback,  QWidget * parent)
{
...
////image features
////const char *weight_file_im ="../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_8_size_21_weigths_cpd_rank_49.txt";
////const char *sep_filters_file_im ="../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_8_size_21_sep_cpd_rank_49.txt";
////auto-context features
//const char *weight_file_ac = "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/proto_filter_AC_lap_633_822_weigths_cpd_rank_49.txt";
//const char *sep_filters_file_ac = "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/proto_filter_AC_lap_633_822_sep_cpd_rank_49.txt";

////inv filters
////const char *weight_file_ac ="../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_8_size_21_weigths_cpd_rank_49.txt";
////const char *sep_filters_file_ac ="../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_8_size_21_sep_cpd_rank_49.txt";
//////auto-context features
////const char *weight_file_im = "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/proto_filter_AC_lap_633_822_weigths_cpd_rank_49.txt";
////const char *sep_filters_file_im = "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/proto_filter_AC_lap_633_822_sep_cpd_rank_49.txt";


//const char *sep_filters_file_im = "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_size_13_sep_cpd_rank_49.txt";
//const char *weight_file_im = "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_size_13_weigths_cpd_rank_49.txt";
...
bool trainTubularityImage(VISIOCYTEPluginCallback2 &callback, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output)
{
    ...
    ITKImageType::SizeType * size_img = new ITKImageType::SizeType[n_train_images];
        ...
        for(unsigned int i_img =0; i_img<n_train_images; i_img++){
            ...
            VISIOCYTELONG train_img_size[4];
            ...
            train_img_ITK =visiocyte2ItkImage<ITKImageType,ImageScalarTypeUint8>(train_img,train_img_size,channel);
            ...
            if(gt_extension.find(".swc")!=std::string::npos){
                ...
                cout<<"trying to load it as radial gt.  " << endl;
                 ...
                 {
                   visiocyte_msg("Fail to open the radial gt image file.", 0);
                   return false;
                 }
                  train_gt_radial_ITK = visiocyte2ItkImage<ITKImageType,ImageScalarTypeUint8>(train_radial_gt,train_img_size,channel);
            ...
            //save radial gt and image to check size and  axis
                        //radial gt
                 //       Image4DSimple *train_radial_gt = callback.loadImage("../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/cropped_N2_scaled_radial_gt_uint8.tif");
                 //       callback.saveImage(train_radial_gt, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/temp_results/swc_gt_debug.visiocyteraw");

                        //debug: save radial gt
                        Image4DSimple radial_img_debug = itk2visiocyteImage<ITKImageType>(train_gt_radial_ITK);
                        std::string name_radial_gt_temp = swc_gt_file_string + "_radial_gt.visiocyteraw";
...
//                        //size input image
//                        std::cout << "visiocyte input X: " << train_img->getXDim() << " Y: " << train_img->getYDim() << " z: " << train_img->getZDim() << std::endl;
//                     //   std::cout << "visiocyte input resX: " << train_img->getRezX() << " Y: " << train_img->getRezY() << " z: " << train_img->getRezZ() << std::endl;
//                       //size input itk
...
//                        //size visiocyte radial
//                        std::cout << "visiocyte Rad X: " << radial_img_debug.getXDim() << " Y: " << radial_img_debug.getYDim() << " z: " << radial_img_debug.getZDim() << std::endl;
//                 //       std::cout << "visiocyte Rad resX: " << radial_img_debug.getRezX() << " Y: " << radial_img_debug.getRezY() << " z: " << radial_img_debug.getRezZ() << std::endl;
            ...
            VISIOCYTELONG n_pixels = size_img[i_img][0]*size_img[i_img][1]*size_img[i_img][2];
...
//            writeMatrix<MatrixTypeFloat>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/feats_AC1.txt",all_samples_features.cast<float>());
//            writeMatrix<MatrixTypeDouble>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/gt_AC1.txt",all_samples_gt.cast<double>());

//        }else{

//             cout<<"writing matrix :" << endl;
//            writeMatrix<MatrixTypeFloat>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/feats_AC0.txt",all_samples_features.cast<float>());
//            writeMatrix<MatrixTypeDouble>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/gt_AC0.txt",all_samples_gt.cast<double>());
...
//                if(i_ac>0){
//        cout<<"writing matrix ac1 :" << endl;
//                    writeMatrix<MatrixTypeFloat>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/feats_AC1_all.txt",features_image_and_ac.cast<float>());
//                //    writeMatrix<MatrixTypeDouble>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/gt_AC1.txt",all_samples_gt.cast<double>());

//                }else{

//                     cout<<"writing matrix :" << endl;
//                    writeMatrix<MatrixTypeFloat>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/feats_AC0_all.txt",features_image_and_ac.cast<float>());
//                    //writeMatrix<MatrixTypeDouble>("/cvlabdata1/home/asironi/visiocyte/visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/regression/results/gt_AC0.txt",all_samples_gt.cast<double>());
...
//  bool multiscale_pred = true; //todo: pass as arguments
  ...
  const char *sep_filters_file_im = (paras.at(0));//"../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_size_13_sep_cpd_rank_49.txt";
  const char *weight_file_im = (paras.at(1));//"../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/oof_fb_3d_scale_1_2_3_5_size_13_weigths_cpd_rank_49.txt";

  const char *sep_filters_file_ac = (paras.at(2));// "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/proto_filter_AC_lap_633_822_weigths_cpd_rank_49.txt";
  const char *weight_file_ac = (paras.at(3));//"../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/data/filter_banks/proto_filter_AC_lap_633_822_sep_cpd_rank_49.txt";
...
//  std::cout << "wei filt ac: " << weight_file_ac << std::endl;
  ...
  for(unsigned int imgInd = 0; imgInd < inputImagePaths->size(); imgInd++) {
    ...
    VISIOCYTELONG n_pixels = in_sz[0]*in_sz[1]*in_sz[2];
    ...
    I =visiocyte2ItkImage<ITKImageType,ImageScalarTypeUint8>(inimg,in_sz,c);
   ...
   // bool crop_images = true;
    ...
    long int *crop_start_idxs ;
    long int *in_sz_cropped;
    VISIOCYTELONG n_pixels_cropped;
    ...
    if(crop_images){
        ...
        I_cropped = cropItkImageUniformBackground<ITKImageType>(I,crop_start_idxs,in_sz_cropped,uniform_thresh);
         ...
         if(in_sz_cropped[0]*in_sz_cropped[1]*in_sz_cropped[2]<1){
             ...
             outimg_final_emty.setData((unsigned char *)(out_data_zero), in_sz[0], in_sz[1], in_sz[2], 1, VISIOCYTE_UINT8);
  ...
  //       Image4DSimple input_cropped_image = itk2visiocyteImage<ITKImageType>(I_cropped);
  //       callback.saveImage(&input_cropped_image, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/trained_models/OPF_debug/large_image_cropped.visiocyteraw");
  ...
  //  return true;
    ...
    for(unsigned int i_scale=0; i_scale<n_scales; i_scale++){
        ...
        VISIOCYTELONG *out_sz_res= new VISIOCYTELONG[4];
        ...
        if(scales(i_scale) ==1){
           // out_sz_res[0] = in_sz[0];  out_sz_res[1] = in_sz[1];  out_sz_res[2] = in_sz[2]; out_sz_res[3] = 1;
            ...
            //I_resized = resize_image_visiocyte<ITKImageType,unsigned char>(inimg,dfactor,out_sz_res);
            I_resized = resize_image_visiocyte<ITKImageType,unsigned char>(inimg_cropped,dfactor,out_sz_res);
        ...
        VISIOCYTELONG n_pixels_scaleed = size_img_scaled[0]*size_img_scaled[1]*size_img_scaled[2];
        ...
        if(n_pixels_scaleed>max_pixels_predict){
            ...
            Image4DSimple img_cropped_visiocyte = itk2visiocyteImage<ITKImageType>(I_resized);

            VISIOCYTELONG *out_sz_down= new VISIOCYTELONG[4];
...
//            }
            ...
            I_resized = downsample_image_visiocyte<ITKImageType,float>(&img_cropped_visiocyte,dfactor_down,out_sz_down);
...
////debug
//        Image4DSimple img_down_visiocyte_debug = itk2visiocyteImage<ITKImageType>(I_resized);
//            char outimg_file_debug [500];

//                sprintf (outimg_file_debug, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/temp_results/image_downsampled.visiocyteraw");

//                cout << "saving debug results: " << outimg_file_debug<<endl;
//              callback.saveImage(&img_down_visiocyte_debug, outimg_file_debug);
...
////
        ...
        //// DEBUG
/*
        VISIOCYTELONG *out_sz_res_debug= new VISIOCYTELONG[4];
        double *dfactor_debig = new double[3];
        dfactor_debig[0] = 2.0; dfactor_debig[1] = 2.0;  dfactor_debig[2] =2.0;
        ITKImageType::Pointer I_down_debug = downsample_image_visiocyte<ITKImageType,unsigned char>(inimg,dfactor_debig,out_sz_res_debug);

        std::cout << "size img down: " << out_sz_res_debug << std::endl << std::flush;

        Image4DSimple img_down_visiocyte_debug = itk2visiocyteImage<ITKImageType>(I_down_debug);
        ...
        char outimg_file_debug [500];
          ...
          VISIOCYTELONG *out_sz_res_debug_up= new VISIOCYTELONG[4];
          ...
          dfactor_debig_up[0] = dfactor_debig[0]; dfactor_debig_up[1] = dfactor_debig[0];  dfactor_debig_up[2] =dfactor_debig[0];
           ITKImageType::Pointer I_up_debug = upsample_image_visiocyte<ITKImageType,float>(&img_down_visiocyte_debug,dfactor_debig_up,out_sz_res_debug_up);


           Image4DSimple img_down_visiocyte_debug_up = itk2visiocyteImage<ITKImageType>(I_up_debug);

           char outimg_file_debug_up [500];

               sprintf (outimg_file_debug_up, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/temp_results/image_upsampled.visiocyteraw");

               cout << "saving debug results: " << outimg_file_debug_up<<endl;
             callback.saveImage(&img_down_visiocyte_debug_up, outimg_file_debug_up);
...
//    }
//temp_feat_cropped.setData((unsigned char *)(temp_feat_cropped_vec), in_sz_cropped[0], in_sz_cropped[1], in_sz_cropped[2], 1, VISIOCYTE_FLOAT32);
// callback.saveImage(&temp_feat_cropped, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/trained_models/BF_debug2/temp_feat_cropped.visiocyteraw");
            ...
            if(i_ac==n_ac_iters){
                ...
                if(scales(i_scale) ==1 && !downsampled){
                    ...
                    std::cout << "Upsampling score back." <<std::endl;
                       ...
                       Image4DSimple pred_img_visiocyte =  itk2visiocyteImage<ITKImageType>(pred_img_itk);


                       VISIOCYTELONG *out_sz_res_up= new VISIOCYTELONG[3];
...
//                       dfactor_up[0] = dfactor_down[0]; dfactor_up[1] = dfactor_down[0];  dfactor_up[2] =dfactor_down[0];
                     ...
                     //  predImg_scaled_original_size = upsample_image_visiocyte<ITKImageType,float>(&pred_img_visiocyte,dfactor_up,out_sz_res_up);

                      predImg_scaled_original_size = upsample_image_visiocyte_size<ITKImageType,float>(&pred_img_visiocyte,out_sz_res_up);
...
//                        Image4DSimple img_down_visiocyte_up = itk2visiocyteImage<ITKImageType>(predImg_scaled_original_size);
//                            char outimg_file_debug_up [500];

//                                sprintf (outimg_file_debug_up, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/temp_results/image_upsampled.visiocyteraw");

//                                cout << "saving debug results: " << outimg_file_debug_up<<endl;
//                              callback.saveImage(&img_down_visiocyte_up, outimg_file_debug_up);

//                              char outimg_file_debug_up_before [500];

//                                  sprintf (outimg_file_debug_up_before, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/temp_results/image_before_upsampled.visiocyteraw");

//                                  cout << "saving debug results: " << outimg_file_debug_up_before<<endl;
//                                callback.saveImage(&pred_img_visiocyte, outimg_file_debug_up_before);
                    ...
                    VISIOCYTELONG *out_sz_back = new VISIOCYTELONG[4];
...
//                 scale_factor_inv[2] = ((double)in_sz[2])/((double)out_sz_res[2]);
                 ...
                 scale_factor_inv[2] = ((double)in_sz_cropped[2])/((double)out_sz_res[2]);
                   ...
                   Image4DSimple pred_img_visiocyte =  itk2visiocyteImage<ITKImageType>(pred_img_itk);
                    ...
                    predImg_scaled_original_size = resize_image_visiocyte<ITKImageType,float>(&pred_img_visiocyte,scale_factor_inv,out_sz_back);
...
//                //copy data to save with visiocyte format
//               // VISIOCYTELONG n_pixels = in_sz[0]*in_sz[1]*in_sz[2];
...
//         outimg1.setData((unsigned char *)(out_data_copy), size_img_scaled[0], size_img_scaled[1], size_img_scaled[2], 1, VISIOCYTE_FLOAT32);



//                char outimg_file_ac [500];

//                    sprintf (outimg_file_ac, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/temp_results/score_img_%i_ac_%i_scale_%i.visiocyteraw",imgInd,i_ac,i_scale);
...
//     outimg_final.setData((unsigned char *)(out_data_copy_final), in_sz[0], in_sz[1], in_sz[2], 1, VISIOCYTE_FLOAT32);
...
//        }
//    outimg_final_cropped.setData((unsigned char *)(out_data_copy_final_cropped), in_sz_cropped[0], in_sz_cropped[1], in_sz_cropped[2], 1, VISIOCYTE_UINT8);

//     callback.saveImage(&outimg_final_cropped, "../../visiocyte_tools/bigneuron_ported/AmosSironi_PrzemyslawGlowacki/SQBTree_plugin/trained_models/BF_debug2/cropped_N2_uint8_tubularity_cropped_cropped.visiocyteraw");
...
//    }
   ...
   //   h = in_sz_cropped[0]; w = in_sz_cropped[1]; d = in_sz_cropped[2]; // size region to crop
    ...
    outimg_final.setData((unsigned char *)(out_data_copy_final), in_sz[0], in_sz[1], in_sz[2], 1, VISIOCYTE_UINT8);
