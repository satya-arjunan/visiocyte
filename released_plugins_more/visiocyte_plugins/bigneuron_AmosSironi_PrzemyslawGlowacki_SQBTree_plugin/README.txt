...
./visiocyte -x RegressionTubularityAC -f train
...
Input: Supported formats: Tiff and visiocyte raw UINT8 3d volumes
...
./visiocyte -x RegressionTubularityAC -f test
...
Input: Supported formats: Tiff and visiocyte raw UINT8 3d volumes
Output: format: visiocyte raw FLOAT32 3d volumes
