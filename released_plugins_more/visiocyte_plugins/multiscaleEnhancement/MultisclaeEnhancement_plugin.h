...
class selectiveEnhancement : public QObject, public VISIOCYTEPluginInterface2_1
{
	Q_OBJECT
	Q_INTERFACES(VISIOCYTEPluginInterface2_1);

public:
    float getPluginVersion() const {return 0.11f;}
...
class MultiscaleEnhancementDialog : public QDialog
    ...
    public:
        MultiscaleEnhancementDialog(VISIOCYTEPluginCallback2 &cb, QWidget *parent)
        {
