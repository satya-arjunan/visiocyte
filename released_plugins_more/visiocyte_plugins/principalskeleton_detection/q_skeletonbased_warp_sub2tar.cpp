...
bool q_skeletonbased_sub2tar(
		const unsigned char *p_img_tar,const VISIOCYTELONG *sz_img_tar,
		const unsigned char *p_img_sub,const VISIOCYTELONG *sz_img_sub,
...
//	saveImage("/Users/qul/work/visiocyte_2.0/q_skeletonbased_warp_sub2tar/data/VNC/sub2tar.tif",(unsigned char *)p_img_sub2tar,sz_img_tar,1);
...
bool q_resize_image(
		...
		const VISIOCYTELONG sz_img_output[4],
...
//	q_points_save2markerfile(vec_controlpoint_candidate_tar,"/Users/qul/work/visiocyte_2.0/q_skeletonbased_warp_sub2tar/data/tar_candi.marker");
//	q_points_save2markerfile(vec_controlpoint_candidate_sub,"/Users/qul/work/visiocyte_2.0/q_skeletonbased_warp_sub2tar/data/sub_candi.marker");
...
//	q_points_save2markerfile(vec_controlpoint_tar,"/Users/qul/work/visiocyte_2.0/q_skeletonbased_warp_sub2tar/data/tar.marker");
//	q_points_save2markerfile(vec_controlpoint_sub,"/Users/qul/work/visiocyte_2.0/q_skeletonbased_warp_sub2tar/data/sub.marker");
...
bool q_saveimg_strmask_overlaid(
        const unsigned char *p_inputimg, VISIOCYTELONG sz_inputimg[4],
		const vector< vector< vector<Coord2D64F_SL> > > vecvecvec_index_ori2str_branches,
        const char *filename_outputimg,VISIOCYTEPluginCallback2 &callback)
{
	//check parameters
	if(!p_inputimg)
	{
