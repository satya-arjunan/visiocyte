...
class neurontracer : public QObject, public VISIOCYTEPluginInterface2_1
{
	Q_OBJECT
	Q_INTERFACES(VISIOCYTEPluginInterface2_1);

public:
    float getPluginVersion() const {return 1.46f;}
...
class neurontracer_app2_raw : public QDialog
    ...
    public:
        neurontracer_app2_raw(VISIOCYTEPluginCallback2 &cb, QWidget *parent)
        {
            image = 0;

            visiocytehandle curwin = cb.currentImageWindow();
            if (curwin)
            {
                ...
                {
                    visiocyte_msg("No markers in the current image, please select a marker.");
                    return;
                }
            }
...
//            layout->addWidget(b_adapWinchecker);
            ...
            layout->addWidget(new QLabel(QObject::tr("visiocyteraw/raw image or tc file:")),7,0);
        ...
        void _slots_openrawFile()
        {
            ...
            fileOpenName = QFileDialog::getOpenFileName(0, QObject::tr("Open Raw File/TC File"),
                                                        "",
                                                        QObject::tr("Supported file (*.raw *.RAW *.VISIOCYTERAW *.visiocyteraw *.tc)"
                                                            ));
...
class neurontracer_app1_raw : public QDialog
    ...
    public:
        neurontracer_app1_raw(VISIOCYTEPluginCallback2 &cb, QWidget *parent)
        {
            image = 0;
            int chn_num = 3;
            visiocytehandle curwin = cb.currentImageWindow();
            ...
            layout->addWidget(new QLabel(QObject::tr("visiocyteraw/raw image or tc file:")),5,0);
...
class neurontracer_most_raw : public QDialog
    ...
    public:
        neurontracer_most_raw(VISIOCYTEPluginCallback2 &cb, QWidget *parent)
        {
            image = 0;
            int chn_num = 3;
            visiocytehandle curwin = cb.currentImageWindow();
            ...
            layout->addWidget(new QLabel(QObject::tr("visiocyteraw/raw image:")),5,0);
            layout->addWidget(raw_filepath,5,1,1,4);
            layout->addWidget(openrawFile,5,5,1,1);
...
class neurontracer_neutube_raw : public QDialog
    ...
    public:
        neurontracer_neutube_raw(VISIOCYTEPluginCallback2 &cb, QWidget *parent)
        {
            image = 0;
            visiocytehandle curwin = cb.currentImageWindow();
            if (curwin)
