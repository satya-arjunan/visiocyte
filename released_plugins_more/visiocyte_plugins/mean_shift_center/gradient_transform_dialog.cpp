...
gradient_transform_dialog::gradient_transform_dialog(VISIOCYTEPluginCallback2 *cb)
{
    callback=cb;
    image1Dc_in=0;
...
//    }
    ...
    callback->setImageName(visiocytehandle_main, "gradient_dist_trans"+callback->getImageName(curwin));
