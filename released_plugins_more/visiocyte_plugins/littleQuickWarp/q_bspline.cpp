...
//	VISIOCYTELONG gsz0 = (VISIOCYTELONG)(ceil((double(sz0)/gfactor_x)))+1, gsz1 = (VISIOCYTELONG)(ceil((double(sz1)/gfactor_y)))+1, gsz2 = (VISIOCYTELONG)(ceil((double(sz2)/gfactor_z)))+1;
	VISIOCYTELONG gsz0 = (VISIOCYTELONG)(ceil((double(sz0)/gfactor_x)))+1+2, gsz1 = (VISIOCYTELONG)(ceil((double(sz1)/gfactor_y)))+1+2, gsz2 = (VISIOCYTELONG)(ceil((double(sz2)/gfactor_z)))+1+2;//+2 for bspline
