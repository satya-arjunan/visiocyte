...
public:
  ...
  public:
    ...
    inline bool isExpandVisiocyteApoOn() const {
      return m_isExpandVisiocyteApoOn;
    }

    inline bool isExpandVisiocyteMarkerOn() const{
      return m_isExpandVisiocyteMarkerOn;
    }
  ...
  private:
    ...
    bool m_isExpandVisiocyteApoOn;
    bool m_isExpandVisiocyteMarkerOn;
