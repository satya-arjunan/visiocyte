...
void MainWindow::customizeActions()
{
  ...
  m_ui->actionVISIOCYTE_Apo->setVisible(
        config.getMainWindowConfig().isExpandVisiocyteApoOn());
  m_ui->actionVISIOCYTE_Marker->setVisible(
        config.getMainWindowConfig().isExpandVisiocyteMarkerOn());
