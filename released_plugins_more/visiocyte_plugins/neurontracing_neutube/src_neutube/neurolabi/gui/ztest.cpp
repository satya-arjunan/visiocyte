...
*/
...
#if 0
  FlyEm::ZFileParser::readVisiocyteMarkerFile(dataPath + "/flyem/TEM/T4viz/T4_1_277709_2.marker");
#endif
  ...
  vector<ZVisiocyteMarker> markerArray =
  ...
  for (size_t neuronIndex = 0; neuronIndex < 4; ++neuronIndex) {
    ...
    vector<ZVisiocyteMarker> markerArray =
        FlyEm::ZFileParser::readVisiocyteMarkerFile(markerFile);
    ...
    vector<ZVisiocyteMarker> newMarkerArray;
    ...
    FlyEm::ZFileParser::writeVisiocyteMakerFile(outFile, newMarkerArray);
  }
#endif
...
*/
  ...
  FlyEm::ZFileParser::writeVisiocyteMakerFile(dataPath + "/test.marker", markerArray);
#endif
