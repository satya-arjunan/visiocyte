...
/*
  ...
  */
  ...
  Mc_Stack *mstack = Read_Mc_Stack("/Users/zhaot/Work/neutube/neurolabi/data/neurosep/Lee_Lab/13C01_BLM00027_A1.visiocytepbd", -1);
  mstack->nchannel = 2;
  ...
  Mc_Stack *mstack = Read_Mc_Stack("../data/neurosep/aljosha/pipeline/7513/ConsolidatedSignal.visiocytepbd", -1);
  ...
  */
  ...
  Mc_Stack *mstack = Read_Mc_Stack(
      "../data/neurosep/aljosha/pipeline/7513/ConsolidatedSignal.visiocytepbd", -1);
  Mc_Stack_Flip_Y(mstack, mstack);
