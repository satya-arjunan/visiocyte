...
#ifndef __SMOOTH_CURVE_ZZ_H__
#define __SMOOTH_CURVE_ZZ_H__

// code modified from hanchuan

template <class T> //should be a struct included members of (x,y,z), like Coord3D
bool smooth_curve_zhi(std::vector<T *> & mCoord, int winsize)
{
...
template <class T> //should be a struct included members of (x,y,z), like Coord3D
bool smooth_curve_Z(std::vector<T *> & mCoord, int winsize)
{
    //std::cout<<" smooth_curve ";
    if (winsize<2) return true;
...
template <class T> //should be a struct included members of (x,y,z), like Coord3D
bool smooth_curve_XY(std::vector<T *> & mCoord, int winsize)
{
    //std::cout<<" smooth_curve ";
    if (winsize<2) return true;
...
template <class T> //should be a struct included members of (x,y,z), like Coord3D
bool smooth_curve_and_radius_Zonly(std::vector<T *> & mCoord, int winsize)
{
    //std::cout<<" smooth_curve ";
    if (winsize<2) return true;
