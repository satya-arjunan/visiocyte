...
class neurontracing_mip : public QObject, public VISIOCYTEPluginInterface2_1
{
	Q_OBJECT
...
class mipTracingeDialog : public QDialog
    ...
    public:
        mipTracingeDialog(VISIOCYTEPluginCallback2 &cb, QWidget *parent)
        {
            image = 0;
            ...
            if (!curwin)
            {
                visiocyte_msg("You don't have any images open in the main window.");
                return;
            }
