...
public:
        ImageStitchingDialog(VISIOCYTEPluginCallback &callback, QWidget *parentWidget)
	{
...
public:
        GroupImageStitchingDialog(VISIOCYTEPluginCallback &callback, QWidget *parentWidget, QString filename)
	{
		...
		check_img_show->setText(QObject::tr("Display the stitching result in VISIOCYTE immediately"));
...
public:
        PointNavigateDialog(QWidget *parentWidget, VISIOCYTELONG *sz)
	{		
		// create a dialog
		v_x = new QSpinBox(); 
		v_y = new QSpinBox();
...
public:
    RegionNavigateDialog(QWidget *parentWidget, VISIOCYTELONG *sz)
	{		
		// create a dialog
