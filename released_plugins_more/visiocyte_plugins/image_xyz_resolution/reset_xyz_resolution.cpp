...
bool processImage(VISIOCYTEPluginCallback2 &callback, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, unsigned int flag);
...
void example_reset_xyz_resolutionPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback2 &callback, QWidget *parent)
{
     //choosing flag
	unsigned int flag = 0;
     ...
     else if(menu_name == tr("about this plugin"))
	{
          QMessageBox::information(parent, "Version info",
                QString("Check and set image voxel xyz resolution %1 (2010-Jun-26): this demo is developed by Hanchuan Peng to show VISIOCYTE plugin capability.")
...
bool example_reset_xyz_resolutionPlugin::dofunc(const QString &func_name, const VISIOCYTEPluginArgList &input, VISIOCYTEPluginArgList &output, VISIOCYTEPluginCallback2 &callback, QWidget *parent)
{
     if(func_name == tr("help"))
     {
          cout<<"Usage : visiocyte -x resolution -f help"<<endl;
          cout<<"The resolution is not saved in VISIOCYTE image. Please use domenu() function to check and set it."<<endl;
          return true;
     }
	...
	// {
	// 	cout<<"Usage : visiocyte -x resolution -f setsz -i <inimg_file> -o <outimg_file> -p <rezx> <rezy> <rezz> "<<endl;
	// 	cout<<endl;
	...
	// 	cout<<"rezz          voxel size in z direction, default 1"<<endl;
     //      cout<<endl;
	// 	cout<<"e.g. visiocyte -x resolution -f setsz -i input.raw -o output.raw -p 1 1 1"<<endl;
	// 	cout<<endl;
     //      cout<<"Usage : visiocyte -x resolution -f checksz -i <inimg_file> "<<endl;
	// 	cout<<endl;
	// 	return true;
	// }
}
