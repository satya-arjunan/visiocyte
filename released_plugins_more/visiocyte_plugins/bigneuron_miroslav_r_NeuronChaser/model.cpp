...
void Model::save(VISIOCYTEPluginCallback2 &callback, QString inimg_path)
{
    ...
    for (int ki = 0; ki < Ndir*nr_sigmas; ++ki) {
        ...
        simple_saveimage_wrapper(callback, out_str.toStdString().c_str(), knl, in_sz, VISIOCYTE_UINT8);
