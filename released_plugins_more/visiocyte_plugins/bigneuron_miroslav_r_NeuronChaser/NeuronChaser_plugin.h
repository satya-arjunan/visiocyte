 ...
 * 2015-5-31 : by MiroslavR
 */
 
#ifndef __NEURONCHASER_PLUGIN_H__
#define __NEURONCHASER_PLUGIN_H__

#include <QtGui>
#include <visiocyte_interface.h>

class NeuronChaser : public QObject, public VISIOCYTEPluginInterface2_1
{
	Q_OBJECT
