...
void BTracer::save_templates(VISIOCYTEPluginCallback2 &callback, QString inimg_path) {
    ...
    for (int ti = 0; ti < gcsstd_nr; ++ti) {
        ...
        simple_saveimage_wrapper(callback, out_str.toStdString().c_str(), tplt, in_sz, VISIOCYTE_UINT8);

//        Image4DSimple outimg1;
//        outimg1.setData(knl, in_sz[0], in_sz[1], in_sz[2], in_sz[3], VISIOCYTE_UINT8);
