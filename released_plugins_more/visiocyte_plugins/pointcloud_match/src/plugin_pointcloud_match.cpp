...
void PointMatchFromImageMarker(VISIOCYTEPluginCallback &callback, QWidget *parent);
void PointMatchFromMarkerFile(VISIOCYTEPluginCallback &callback, QWidget *parent);
void PointMatchFromSWCFile(VISIOCYTEPluginCallback &callback, QWidget *parent);
void PointMatchFromAPOFile(VISIOCYTEPluginCallback &callback, QWidget *parent);
void BatchMatchFromANOFile(VISIOCYTEPluginCallback &callback, QWidget *parent);
...
void PointCloudMatchPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback &callback, QWidget *parent)
{
