...
void neuron_assembler_live::domenu(const QString &menu_name, VISIOCYTEPluginCallback2 &callback, QWidget *parent)
{
	...
	{
		visiocyte_msg(tr("This plugin will connect fragments, break loop, and combine neuron files in live.. "
			"Developed by Hanbo Chen, 2015-7-8"));
	}
}

bool neuron_assembler_live::dofunc(const QString & func_name, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, VISIOCYTEPluginCallback2 & callback,  QWidget * parent)
{
