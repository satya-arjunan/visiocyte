...
INCLUDEPATH     += $$VISIOCYTEPATH/visiocyte_main/basic_c_fun/customary_structs
INCLUDEPATH     += $$VISIOCYTEPATH/visiocyte_main
INCLUDEPATH     += $$QT_PATH/demos/shared

macx{
    INCLUDEPATH += $$VISIOCYTEPATH/visiocyte_main/common_lib/include/hdf5
    LIBS += -L$$VISIOCYTEPATH/visiocyte_main/common_lib/lib_mac64 -lhdf5 -lszip -lz
...
unix {
INCLUDEPATH += $$VISIOCYTEPATH/visiocyte_main/common_lib/include/hdf5
LIBS += -L$$VISIOCYTEPATH/visiocyte_main/common_lib/lib_unix64 -lhdf5 -lszip -lz -ldl
}
...
DESTDIR	= $$VISIOCYTEPATH/bin/plugins/neuron_utilities/assemble_neuron_live/
