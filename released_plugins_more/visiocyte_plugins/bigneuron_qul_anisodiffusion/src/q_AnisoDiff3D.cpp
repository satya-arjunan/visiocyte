...
bool q_AnisoDiff3D(const float *p_img32f_input,const VISIOCYTELONG sz_img_input[4],float *&p_img32f_output)
{
	//check paras
	if(p_img32f_input==0)
	{
	...
	for(unsigned int iter=0;iter<20;iter++)
	{
		...
		float *p_img32f_gradx=0,*p_img32f_grady=0,*p_img32f_gradz=0;
		{
			...
			if(iter==0)
			{
				...
				//	saveImage("d:/SVN/Visiocyte_source_code/visiocyte_external/released_plugins/visiocyte_plugins/anisodiffusion_littlequick/mask.raw",p_img_tmp,sz_img_input,1);
				//	delete []p_img_tmp;
				//}
			}
	...
	//	saveImage("d:/SVN/Visiocyte_source_code/visiocyte_external/released_plugins/visiocyte_plugins/anisodiffusion/output.raw",p_img_tmp,sz_img_input,1);
	//	delete []p_img_tmp;
	//}
