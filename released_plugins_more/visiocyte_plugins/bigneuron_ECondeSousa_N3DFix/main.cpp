...
int _main(VISIOCYTEPluginCallback2 &callback, QWidget *parent){
    ...
    load_data(x,y,z,tree_id,r,ppid,pid,fileOpenName);
    {
        ...
        if( pid.at(0)!=1){
            visiocyte_msg("First point in swc file should have id = 1.\n\n"
        ...
        if( ppid.at(0)!=-1){
            visiocyte_msg("first point in swc file should be the root.\n\n"
                    "Please fix the input swc file.\n\nSee shell for more info.\n\n"
                    "You can use the plug-in neuron_utilities > sort_neuron_swc > sort_swc\n\n");
            std::cout<<"\n\n======================================================"<<std::endl;
            std::cout<<"======================================================"<<std::endl;
...
bool N3DFix_func(const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output){
    clock_t begin = clock();
