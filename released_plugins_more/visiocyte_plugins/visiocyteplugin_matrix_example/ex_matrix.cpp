...
bool compute(const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, int method);
bool check_input_output(const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output,
...
bool ExMatrixPlugin::dofunc(const QString & func_name, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output,
...
bool check_args(const VISIOCYTEPluginArgList & args, const QStringList & types)
{
...
bool compute(const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, int method_code)
{
	if (method_code=='+')
	{
