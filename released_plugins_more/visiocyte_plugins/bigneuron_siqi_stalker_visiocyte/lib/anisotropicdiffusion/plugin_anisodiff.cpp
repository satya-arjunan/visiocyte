 ...
 */
//todo: 
//1.add bad_alloc handler, show output in visiocyte -->done!
//2.add dofunc, help
//3.add small memory funcs
//end: rebuild visiocyte and write the note
...
void AnisoDiffPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback2 &callback, QWidget *parent)
{
...
bool AnisoDiffPlugin::dofunc(const QString & func_name, const VISIOCYTEPluginArgList & input, VISIOCYTEPluginArgList & output, VISIOCYTEPluginCallback2 & callback,  QWidget * parent)
{
...
void printHelp()
{
	...
	printf("\nUsage: visiocyte -x <anisodiff> -f anisodiff -i <inimg_file> \n");
