...
class ImageFusionPlugin : public QObject, public VISIOCYTEPluginInterface2_1
{
    Q_OBJECT
...
public:
    ImageFusionDialog(VISIOCYTEPluginCallback &callback, QWidget *parentWidget, QString folder)
	{
