...
//compute 2D gradient 
template <class T> void gradient(T **image, float **fx, float **fy, const VISIOCYTELONG *sz)
{
	int x,y;
...
//compute 3D gradient
template <class T> void gradient(T ***image, float ***fx, float ***fy, float ***fz, const VISIOCYTELONG *sz)
{
	int x,y,z;
...
void gradientNoramlize(float **fx, float **fy, const VISIOCYTELONG *sz)
{
	int x,y;
	float tmp;
...
void gradientNoramlize(float ***fx, float ***fy, float ***fz, const VISIOCYTELONG *sz)
{
	int x,y,z;
	float tmp;
...
template <class T> void laplacian(T **image, float **lap, const VISIOCYTELONG *sz)
{
	int x,y;
...
//float **Dirac(float **x, float sigma, const VISIOCYTELONG *sz)
void Dirac(float **x, float sigma, const VISIOCYTELONG *sz, float **f2d)
{
...
//   VISIOCYTELONG tmplen = sz[0]*sz[1];
...
void Dirac(float ***x, float sigma, const VISIOCYTELONG *sz, float ***f3d)
{
...
//   VISIOCYTELONG tmplen = sz[0]*sz[1]*sz[2];
...
//float **curvatureCentral(float **nx, float **ny, const VISIOCYTELONG *sz, float **K)
void curvatureCentral(float **nx, float **ny, const VISIOCYTELONG *sz, float **K)
{
...
// K is the output
float ***curvatureCentral(float ***nx, float ***ny, float ***nz, const VISIOCYTELONG *sz, float ***K)
{
...
//float ** NeumannBoundCond(float **f, const VISIOCYTELONG *sz)
//void NeumannBoundCond(float ** &f, const VISIOCYTELONG *sz)
void NeumannBoundCond(float ** f, const VISIOCYTELONG *sz)
{
...
void evloveLevelSet(float **u, float **uneighbor, float **g, float *para, const int numIter, const VISIOCYTELONG *sz)
{
...
void evloveLevelSet(float **u, float **g, float *para, const int numIter, const VISIOCYTELONG *sz)
{
