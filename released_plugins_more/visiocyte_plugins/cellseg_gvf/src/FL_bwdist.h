...
float *dt1d(float *f, VISIOCYTELONG * label, const VISIOCYTELONG n)
{
	float *d = new float[n];
	int *v = new int[n];
...
void dt2d(float *data, VISIOCYTELONG * label, const VISIOCYTELONG *sz) 
{
	VISIOCYTELONG len = std::max(sz[0],sz[1]);
	float *f = new float[len];
	VISIOCYTELONG tmp_j;
	VISIOCYTELONG i,j,k;
	VISIOCYTELONG *lab1 = new VISIOCYTELONG [sz[0]*sz[1]];
	VISIOCYTELONG *lab2 = new VISIOCYTELONG [sz[0]*sz[1]];
...
void dt3d(float *data, VISIOCYTELONG * label, const VISIOCYTELONG *sz) 
{
	
	VISIOCYTELONG i,j,k;
	
	VISIOCYTELONG sz10 = sz[1]*sz[0];
	VISIOCYTELONG sz20 = sz[2]*sz[0];
	VISIOCYTELONG sz12 = sz[1]*sz[2];
	VISIOCYTELONG count;
	VISIOCYTELONG tmp_k, tmp_j;
	
	VISIOCYTELONG len = std::max(std::max(sz[0], sz[1]),sz[2]);
	VISIOCYTELONG len2 = sz[0]*sz[1]*sz[2];
	
	float *f = new float [len];
	VISIOCYTELONG *lab1 = new VISIOCYTELONG [len2];
	VISIOCYTELONG *lab2 = new VISIOCYTELONG [len2];
	VISIOCYTELONG *lab3 = new VISIOCYTELONG [len2];
...
void dt2d_binary(float *data, VISIOCYTELONG * label, const VISIOCYTELONG *sz, unsigned char tag) 
{
	
	VISIOCYTELONG len = sz[0]*sz[1];
...
void dt2d_binary(float *indata, float *outdata, VISIOCYTELONG * label, const VISIOCYTELONG *sz, unsigned char tag) 
{
...
void dt3d_binary(float *data, VISIOCYTELONG * label, const VISIOCYTELONG *sz, unsigned char tag) 
{
...
void dt3d_binary(float *indata, float *outdata, VISIOCYTELONG * label, const VISIOCYTELONG *sz, unsigned char tag) 
{
...
template <class T1, class T2> void dt2d_binary(T1 *indata, T2 *outdata, VISIOCYTELONG * label, const VISIOCYTELONG *sz, unsigned char tag) 
{
	VISIOCYTELONG len = sz[0]*sz[1];
	VISIOCYTELONG i;
...
template <class T1, class T2> void dt3d_binary(T1 *indata, T2 *outdata, VISIOCYTELONG * label, const VISIOCYTELONG *sz, unsigned char tag) 
{
	VISIOCYTELONG len = sz[0]*sz[1]*sz[2];
	VISIOCYTELONG i;
