...
class NeuronSWC; //from visiocyte's basic_surf_objs.h // added by PHC, 2013-01-03
...
bool saveESWC_file(string swc_file, vector<MyMarkerX*> & out_markers, list<string> & infostring);
#endif
