...
void WarpPointsetBaseonMatchedPairs(VISIOCYTEPluginCallback &callback, QWidget *parent);
void WarpImageBaseonMatchedPairs(VISIOCYTEPluginCallback &callback, QWidget *parent);
...
void WarpAffineTPSPlugin::domenu(const QString &menu_name, VISIOCYTEPluginCallback &callback, QWidget *parent)
{
