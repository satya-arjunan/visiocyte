                                                  ...
                                                  VISIOCYTELONG radius)
{
    ...
    VISIOCYTELONG xb = boundValue(x0-radius,0, N-1);
    VISIOCYTELONG xe = boundValue(x0+radius,0, N-1);
    VISIOCYTELONG yb = boundValue(y0-radius,0, M-1);
    VISIOCYTELONG ye = boundValue(y0+radius,0, M-1);
    VISIOCYTELONG zb = boundValue(z0-radius,0, P-1);
    VISIOCYTELONG ze = boundValue(z0+radius,0, P-1);
